var vidyard_player_width_sxS1zjRBtVUd278fsc2JLd = 640;
var vidyard_player_height_sxS1zjRBtVUd278fsc2JLd = 360;
var vidyard_html5_sxS1zjRBtVUd278fsc2JLd = false;
var vidyard_secure_sxS1zjRBtVUd278fsc2JLd = false;
var vidyard_integration_check_sxS1zjRBtVUd278fsc2JLd = function() {};
var vidyard_sxS1zjRBtVUd278fsc2JLd_params = {};
var vidyard_sxS1zjRBtVUd278fsc2JLd_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_sxS1zjRBtVUd278fsc2JLd');
  var playerDetails = {"keywords":"Harmonic mitigation,PowerFlex 755TR,regeneration","thumbnailUrl":"https://play.vidyard.com/sxS1zjRBtVUd278fsc2JLd.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"sxS1zjRBtVUd278fsc2JLd","description":"The PowerFlex 755TR AC drive with TotalFORCE technology features built-in regeneration capability that helps decrease energy consumption by delivering regenerative energy from motors back to the incoming supply. The drive also offers harmonic mitigation. Learn more about how this variable-frequency drive can help your application by viewing this video or going to www.ab.com/drives","name":"PowerFlex 755TR AC Drive 2019 Animation","transcript":"PowerFlex 755TR Drive Solutions\nThe next step in powerful performance. Flexible control.\n7.5 kW – 4550 kW / 10 Hp – 6000 Hp\nVoltage range 400 – 690 V\nLow Harmonic, Regenerative and Modular Drive System Solutions\nPowerFlex 755TR Wall Mount Drives\n10 – 200 Hp / 7.5 – 132 kW\nVoltage range 400 – 690 V\nPowerFlex 755TR Drive\nSmallest footprint floor mount drive\n250 – 500 Hp / 160 – 355 kW\nVoltage range 400 – 690 V\nLCL Filter\nReduces harmonic distortion from the power source\nMinimizes current distortion into the utility grid\nLine Side Converter\nDraws energy without harmonic distortion\nProvides a means for regeneration\nMotor Side Inverter\nControls voltage, current and frequency of the motor\nPower wiring stays connected while units are rolled out (available with floor mount drives)\nAC Pre-Charge Module\nRegulates the input AC current from the incoming power source\nControl Pod\nContains the control platform responsible for motor and system control\nBuilt-in dual ports for EtherNet/IP\nFive option slots for additional options\nPowerFlex 755TR Drive\n250 – 650 Hp / 160 – 500 kW\nVoltage range 400 – 690 V\nPowerFlex 755TR Drive\n700 – 1800 Hp / 500 – 1400 kW\nPowerFlex 755TR Drive\n2400 – 3000 Hp / 1650 – 2500 kW\nVoltage range 400 – 690 V\nLCL Filters (feature available on all configurations)\nReduces harmonic distortion from the power source\nMinimizes current distortion into the utility grid\nLine Side Converters (feature available on all configurations)\nDraws energy without harmonic distortion\nProvides a means for regeneration\nMotor Side Inverters (feature available on all configurations)\nControls voltage, current and frequency of the motor\nPower wiring stays connected while units are rolled out (feature available on floor mount configurations)\nAC Pre-Charge Module (feature available on all configurations)\nRegulates the input AC current from the incoming power source\nControl Pod (feature available on all configurations)\nContains the control platform responsible for motor and system control\nBuilt-in dual ports for EtherNet/IP\nFive option slots for additional options\nEntry and Exit Wiring Bays (feature available on floor mount configurations)\nProvides flexibility for the cable to enter and exit through the top of the cabinet\nPowerFlex 755TR Drive Solutions\nThe next step in powerful performance. Flexible control.\n","uploadDate":"2019-09-03T20:40:28.000Z","duration":"T3M38S","embedUrl":"https://play.vidyard.com/sxS1zjRBtVUd278fsc2JLd","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_sxS1zjRBtVUd278fsc2JLd") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_sxS1zjRBtVUd278fsc2JLd();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/sxS1zjRBtVUd278fsc2JLd.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_sxS1zjRBtVUd278fsc2JLd_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_sxS1zjRBtVUd278fsc2JLd_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_sxS1zjRBtVUd278fsc2JLd_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_sxS1zjRBtVUd278fsc2JLd = true;
          default:
            vidyard_sxS1zjRBtVUd278fsc2JLd_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_sxS1zjRBtVUd278fsc2JLd_params.type || vidyard_sxS1zjRBtVUd278fsc2JLd_params.type !== 'lightbox') {
    vidyard_sxS1zjRBtVUd278fsc2JLd_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_sxS1zjRBtVUd278fsc2JLd_params.hide_html5_playlist !== 'undefined' && vidyard_sxS1zjRBtVUd278fsc2JLd_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_sxS1zjRBtVUd278fsc2JLd_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_sxS1zjRBtVUd278fsc2JLd_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_sxS1zjRBtVUd278fsc2JLd = query_player_width;
    vidyard_player_height_sxS1zjRBtVUd278fsc2JLd = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_sxS1zjRBtVUd278fsc2JLd) / vidyard_player_width_sxS1zjRBtVUd278fsc2JLd;
    vidyard_player_width_sxS1zjRBtVUd278fsc2JLd = query_player_width;
    vidyard_player_height_sxS1zjRBtVUd278fsc2JLd = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_sxS1zjRBtVUd278fsc2JLd) / vidyard_player_height_sxS1zjRBtVUd278fsc2JLd;
    vidyard_player_width_sxS1zjRBtVUd278fsc2JLd = query_player_width;
    vidyard_player_height_sxS1zjRBtVUd278fsc2JLd = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_sxS1zjRBtVUd278fsc2JLd");
  ...
  if (!iframe_container && vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_sxS1zjRBtVUd278fsc2JLd';
  ...
  if (vidyard_secure_sxS1zjRBtVUd278fsc2JLd === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'sxS1zjRBtVUd278fsc2JLd') {
      vidyard_sxS1zjRBtVUd278fsc2JLd_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_sxS1zjRBtVUd278fsc2JLd = true;
    vidyard_sxS1zjRBtVUd278fsc2JLd_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "sxS1zjRBtVUd278fsc2JLd") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_sxS1zjRBtVUd278fsc2JLd === true && vidyard_sxS1zjRBtVUd278fsc2JLd_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd');
        var message = {
          'event': 'parentReferer',
          'uuid': 'sxS1zjRBtVUd278fsc2JLd',
          'data': {
            'value': vidyard_sxS1zjRBtVUd278fsc2JLd_params.referring_url
          }
        }
      ...
      if (!vidyard_sxS1zjRBtVUd278fsc2JLd_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_sxS1zjRBtVUd278fsc2JLd_params.pardot_id = pardot_id;
      ...
      if (!vidyard_sxS1zjRBtVUd278fsc2JLd_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_sxS1zjRBtVUd278fsc2JLd_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_sxS1zjRBtVUd278fsc2JLd_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_sxS1zjRBtVUd278fsc2JLd_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_sxS1zjRBtVUd278fsc2JLd_params.eloqua_id &&
            ((vidyard_secure_sxS1zjRBtVUd278fsc2JLd === true && vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === 'lightbox') ||
             (vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_sxS1zjRBtVUd278fsc2JLd_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === "inline" || vidyard_secure_sxS1zjRBtVUd278fsc2JLd === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'sxS1zjRBtVUd278fsc2JLd';
          Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_sxS1zjRBtVUd278fsc2JLd = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_sxS1zjRBtVUd278fsc2JLd(false, vidyard_player_width_sxS1zjRBtVUd278fsc2JLd, vidyard_player_height_sxS1zjRBtVUd278fsc2JLd);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_sxS1zjRBtVUd278fsc2JLd();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd')
      );

    } else if (vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_sxS1zjRBtVUd278fsc2JLd) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_sxS1zjRBtVUd278fsc2JLd_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['sxS1zjRBtVUd278fsc2JLd'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_sxS1zjRBtVUd278fsc2JLd
  playerIframe = Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'sxS1zjRBtVUd278fsc2JLd';
...
(function () {
  function async_load() {
    var contactId = vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/sxS1zjRBtVUd278fsc2JLd/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_sxS1zjRBtVUd278fsc2JLd(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_sxS1zjRBtVUd278fsc2JLd_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_sxS1zjRBtVUd278fsc2JLd_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd');
  ...
  if (vidyard_secure_sxS1zjRBtVUd278fsc2JLd === true) {
    query_params_string = vidyard_sxS1zjRBtVUd278fsc2JLd_raw_params;
  } else {
    for (var param in vidyard_sxS1zjRBtVUd278fsc2JLd_params) {
      var param_value = vidyard_sxS1zjRBtVUd278fsc2JLd_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_sxS1zjRBtVUd278fsc2JLd" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_sxS1zjRBtVUd278fsc2JLd" class="vidyard_iframe" src="//play.vidyard.com/sxS1zjRBtVUd278fsc2JLd?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_sxS1zjRBtVUd278fsc2JLd() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd');
  if (_theframe) {
    ...
    if (vidyard_secure_sxS1zjRBtVUd278fsc2JLd === true && vidyard_sxS1zjRBtVUd278fsc2JLd_params.type === 'lightbox') {
      vidyard_integration_check_sxS1zjRBtVUd278fsc2JLd();
    }
    ...
    if (vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_sxS1zjRBtVUd278fsc2JLd_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'sxS1zjRBtVUd278fsc2JLd';
      Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd')
...
function fn_vidyard_sxS1zjRBtVUd278fsc2JLd() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_sxS1zjRBtVUd278fsc2JLd / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_sxS1zjRBtVUd278fsc2JLd(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_sxS1zjRBtVUd278fsc2JLd,
            vidyard_player_height_sxS1zjRBtVUd278fsc2JLd,
            319 + (vidyard_player_width_sxS1zjRBtVUd278fsc2JLd / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd');
        var vidyard_span = document.getElementById('vidyard_span_sxS1zjRBtVUd278fsc2JLd');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('sxS1zjRBtVUd278fsc2JLd').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_sxS1zjRBtVUd278fsc2JLd,
    height: vidyard_player_height_sxS1zjRBtVUd278fsc2JLd,
    animate: !vidyard_html5_sxS1zjRBtVUd278fsc2JLd,
    fixed: true
  });
}
