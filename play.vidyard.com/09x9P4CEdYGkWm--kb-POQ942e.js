var vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ = 640;
var vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ = 360;
var vidyard_html5_09x9P4CEdYGkWm$$kb$POQ = false;
var vidyard_secure_09x9P4CEdYGkWm$$kb$POQ = false;
var vidyard_integration_check_09x9P4CEdYGkWm$$kb$POQ = function() {};
var vidyard_09x9P4CEdYGkWm$$kb$POQ_params = {};
var vidyard_09x9P4CEdYGkWm$$kb$POQ_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_09x9P4CEdYGkWm--kb-POQ');
  var playerDetails = {"keywords":"","thumbnailUrl":"https://play.vidyard.com/09x9P4CEdYGkWm--kb-POQ.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"09x9P4CEdYGkWm--kb-POQ","description":"No description","name":"Condition_Sensing_Reverse_Osmosis_Video","transcript":"","uploadDate":"2013-07-29T20:06:08.000Z","duration":"T5M21S","embedUrl":"https://play.vidyard.com/09x9P4CEdYGkWm--kb-POQ","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_09x9P4CEdYGkWm--kb-POQ") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_09x9P4CEdYGkWm--kb-POQ();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/09x9P4CEdYGkWm--kb-POQ.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_09x9P4CEdYGkWm$$kb$POQ_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_09x9P4CEdYGkWm$$kb$POQ_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_09x9P4CEdYGkWm$$kb$POQ_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_09x9P4CEdYGkWm$$kb$POQ = true;
          default:
            vidyard_09x9P4CEdYGkWm$$kb$POQ_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type || vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type !== 'lightbox') {
    vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_09x9P4CEdYGkWm$$kb$POQ_params.hide_html5_playlist !== 'undefined' && vidyard_09x9P4CEdYGkWm$$kb$POQ_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_09x9P4CEdYGkWm$$kb$POQ_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_09x9P4CEdYGkWm$$kb$POQ_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ = query_player_width;
    vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ) / vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ;
    vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ = query_player_width;
    vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ) / vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ;
    vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ = query_player_width;
    vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_09x9P4CEdYGkWm--kb-POQ");
  ...
  if (!iframe_container && vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_09x9P4CEdYGkWm--kb-POQ';
  ...
  if (vidyard_secure_09x9P4CEdYGkWm$$kb$POQ === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_09x9P4CEdYGkWm$$kb$POQ_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_09x9P4CEdYGkWm$$kb$POQ_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_09x9P4CEdYGkWm$$kb$POQ_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_09x9P4CEdYGkWm$$kb$POQ = true;
    vidyard_09x9P4CEdYGkWm$$kb$POQ_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "09x9P4CEdYGkWm--kb-POQ") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_09x9P4CEdYGkWm$$kb$POQ === true && vidyard_09x9P4CEdYGkWm$$kb$POQ_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ');
        var message = {
          'event': 'parentReferer',
          'uuid': '09x9P4CEdYGkWm--kb-POQ',
          'data': {
            'value': vidyard_09x9P4CEdYGkWm$$kb$POQ_params.referring_url
          }
        }
      ...
      if (!vidyard_09x9P4CEdYGkWm$$kb$POQ_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_09x9P4CEdYGkWm$$kb$POQ_params.pardot_id = pardot_id;
      ...
      if (!vidyard_09x9P4CEdYGkWm$$kb$POQ_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_09x9P4CEdYGkWm$$kb$POQ_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_09x9P4CEdYGkWm$$kb$POQ_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_09x9P4CEdYGkWm$$kb$POQ_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_09x9P4CEdYGkWm$$kb$POQ_params.eloqua_id &&
            ((vidyard_secure_09x9P4CEdYGkWm$$kb$POQ === true && vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === 'lightbox') ||
             (vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_09x9P4CEdYGkWm$$kb$POQ_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === "inline" || vidyard_secure_09x9P4CEdYGkWm$$kb$POQ === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = '09x9P4CEdYGkWm--kb-POQ';
          Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_09x9P4CEdYGkWm$$kb$POQ = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_09x9P4CEdYGkWm$$kb$POQ(false, vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ, vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_09x9P4CEdYGkWm$$kb$POQ();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ')
      );

    } else if (vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_09x9P4CEdYGkWm$$kb$POQ) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_09x9P4CEdYGkWm$$kb$POQ_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['09x9P4CEdYGkWm--kb-POQ'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_09x9P4CEdYGkWm$$kb$POQ
  playerIframe = Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = '09x9P4CEdYGkWm--kb-POQ';
...
(function () {
  function async_load() {
    var contactId = vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/09x9P4CEdYGkWm--kb-POQ/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_09x9P4CEdYGkWm$$kb$POQ(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_09x9P4CEdYGkWm$$kb$POQ_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_09x9P4CEdYGkWm$$kb$POQ_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ');
  ...
  if (vidyard_secure_09x9P4CEdYGkWm$$kb$POQ === true) {
    query_params_string = vidyard_09x9P4CEdYGkWm$$kb$POQ_raw_params;
  } else {
    for (var param in vidyard_09x9P4CEdYGkWm$$kb$POQ_params) {
      var param_value = vidyard_09x9P4CEdYGkWm$$kb$POQ_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_09x9P4CEdYGkWm--kb-POQ" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_09x9P4CEdYGkWm--kb-POQ" class="vidyard_iframe" src="//play.vidyard.com/09x9P4CEdYGkWm--kb-POQ?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_09x9P4CEdYGkWm$$kb$POQ() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ');
  if (_theframe) {
    ...
    if (vidyard_secure_09x9P4CEdYGkWm$$kb$POQ === true && vidyard_09x9P4CEdYGkWm$$kb$POQ_params.type === 'lightbox') {
      vidyard_integration_check_09x9P4CEdYGkWm$$kb$POQ();
    }
    ...
    if (vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_09x9P4CEdYGkWm$$kb$POQ_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = '09x9P4CEdYGkWm--kb-POQ';
      Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ')
...
function fn_vidyard_09x9P4CEdYGkWm$$kb$POQ() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_09x9P4CEdYGkWm$$kb$POQ(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ,
            vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ,
            319 + (vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ');
        var vidyard_span = document.getElementById('vidyard_span_09x9P4CEdYGkWm--kb-POQ');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('09x9P4CEdYGkWm--kb-POQ').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_09x9P4CEdYGkWm$$kb$POQ,
    height: vidyard_player_height_09x9P4CEdYGkWm$$kb$POQ,
    animate: !vidyard_html5_09x9P4CEdYGkWm$$kb$POQ,
    fixed: true
  });
}
