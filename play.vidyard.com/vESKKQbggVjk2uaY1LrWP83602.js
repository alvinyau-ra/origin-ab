var vidyard_player_width_vESKKQbggVjk2uaY1LrWP8 = 640;
var vidyard_player_height_vESKKQbggVjk2uaY1LrWP8 = 360;
var vidyard_html5_vESKKQbggVjk2uaY1LrWP8 = false;
var vidyard_secure_vESKKQbggVjk2uaY1LrWP8 = false;
var vidyard_integration_check_vESKKQbggVjk2uaY1LrWP8 = function() {};
var vidyard_vESKKQbggVjk2uaY1LrWP8_params = {};
var vidyard_vESKKQbggVjk2uaY1LrWP8_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_vESKKQbggVjk2uaY1LrWP8');
  var playerDetails = {"keywords":"FLEX 5000 I/O,FLEX I/O,I/Oモジュール,In-Cabinetモジュール式,Logix 5000シリーズ,分散型I/Oソリューション,安全I/Oモジュール","thumbnailUrl":"https://play.vidyard.com/vESKKQbggVjk2uaY1LrWP8.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"vESKKQbggVjk2uaY1LrWP8","description":"複数のアプリケーション向けの柔軟性を備えた新しいFLEX 5000 I/Oは、拡張された1Gb EtherNet/IP接続および柔軟な取付けオプションによってコネクテッドエンタープライズを実現でき、インテリジェントな制御でプロセスに迅速に対応できます。\r\n\r\n詳細は、以下のウェブサイトをご覧ください。https://ab.rockwellautomation.com/ja/IO/In-Cabinet-Modular/FLEX-5000-IO-Modules","name":"FLEX 5000™ I/O の概要","transcript":"","uploadDate":"2018-08-01T03:06:36.000Z","duration":"T3M52S","embedUrl":"https://play.vidyard.com/vESKKQbggVjk2uaY1LrWP8","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_vESKKQbggVjk2uaY1LrWP8") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_vESKKQbggVjk2uaY1LrWP8();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/vESKKQbggVjk2uaY1LrWP8.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_vESKKQbggVjk2uaY1LrWP8_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_vESKKQbggVjk2uaY1LrWP8_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_vESKKQbggVjk2uaY1LrWP8_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_vESKKQbggVjk2uaY1LrWP8 = true;
          default:
            vidyard_vESKKQbggVjk2uaY1LrWP8_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_vESKKQbggVjk2uaY1LrWP8_params.type || vidyard_vESKKQbggVjk2uaY1LrWP8_params.type !== 'lightbox') {
    vidyard_vESKKQbggVjk2uaY1LrWP8_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_vESKKQbggVjk2uaY1LrWP8_params.hide_html5_playlist !== 'undefined' && vidyard_vESKKQbggVjk2uaY1LrWP8_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_vESKKQbggVjk2uaY1LrWP8_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_vESKKQbggVjk2uaY1LrWP8_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_vESKKQbggVjk2uaY1LrWP8 = query_player_width;
    vidyard_player_height_vESKKQbggVjk2uaY1LrWP8 = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_vESKKQbggVjk2uaY1LrWP8) / vidyard_player_width_vESKKQbggVjk2uaY1LrWP8;
    vidyard_player_width_vESKKQbggVjk2uaY1LrWP8 = query_player_width;
    vidyard_player_height_vESKKQbggVjk2uaY1LrWP8 = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_vESKKQbggVjk2uaY1LrWP8) / vidyard_player_height_vESKKQbggVjk2uaY1LrWP8;
    vidyard_player_width_vESKKQbggVjk2uaY1LrWP8 = query_player_width;
    vidyard_player_height_vESKKQbggVjk2uaY1LrWP8 = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_vESKKQbggVjk2uaY1LrWP8");
  ...
  if (!iframe_container && vidyard_vESKKQbggVjk2uaY1LrWP8_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_vESKKQbggVjk2uaY1LrWP8';
  ...
  if (vidyard_secure_vESKKQbggVjk2uaY1LrWP8 === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'vESKKQbggVjk2uaY1LrWP8') {
      vidyard_vESKKQbggVjk2uaY1LrWP8_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_vESKKQbggVjk2uaY1LrWP8 = true;
    vidyard_vESKKQbggVjk2uaY1LrWP8_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "vESKKQbggVjk2uaY1LrWP8") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_vESKKQbggVjk2uaY1LrWP8 === true && vidyard_vESKKQbggVjk2uaY1LrWP8_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8');
        var message = {
          'event': 'parentReferer',
          'uuid': 'vESKKQbggVjk2uaY1LrWP8',
          'data': {
            'value': vidyard_vESKKQbggVjk2uaY1LrWP8_params.referring_url
          }
        }
      ...
      if (!vidyard_vESKKQbggVjk2uaY1LrWP8_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_vESKKQbggVjk2uaY1LrWP8_params.pardot_id = pardot_id;
      ...
      if (!vidyard_vESKKQbggVjk2uaY1LrWP8_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_vESKKQbggVjk2uaY1LrWP8_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_vESKKQbggVjk2uaY1LrWP8_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_vESKKQbggVjk2uaY1LrWP8_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_id = marketo_id;
      ...
      if (vidyard_vESKKQbggVjk2uaY1LrWP8_params.type === "inline" || vidyard_secure_vESKKQbggVjk2uaY1LrWP8 === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'vESKKQbggVjk2uaY1LrWP8';
          Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_vESKKQbggVjk2uaY1LrWP8 = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_vESKKQbggVjk2uaY1LrWP8_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_vESKKQbggVjk2uaY1LrWP8(false, vidyard_player_width_vESKKQbggVjk2uaY1LrWP8, vidyard_player_height_vESKKQbggVjk2uaY1LrWP8);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_vESKKQbggVjk2uaY1LrWP8();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8')
      );

    } else if (vidyard_vESKKQbggVjk2uaY1LrWP8_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_vESKKQbggVjk2uaY1LrWP8) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['vESKKQbggVjk2uaY1LrWP8'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_vESKKQbggVjk2uaY1LrWP8
  playerIframe = Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'vESKKQbggVjk2uaY1LrWP8';
...
(function () {
  function async_load() {
    var contactId = vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/vESKKQbggVjk2uaY1LrWP8/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_vESKKQbggVjk2uaY1LrWP8(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_vESKKQbggVjk2uaY1LrWP8_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_vESKKQbggVjk2uaY1LrWP8_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8');
  ...
  if (vidyard_secure_vESKKQbggVjk2uaY1LrWP8 === true) {
    query_params_string = vidyard_vESKKQbggVjk2uaY1LrWP8_raw_params;
  } else {
    for (var param in vidyard_vESKKQbggVjk2uaY1LrWP8_params) {
      var param_value = vidyard_vESKKQbggVjk2uaY1LrWP8_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_vESKKQbggVjk2uaY1LrWP8" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_vESKKQbggVjk2uaY1LrWP8" class="vidyard_iframe" src="//play.vidyard.com/vESKKQbggVjk2uaY1LrWP8?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_vESKKQbggVjk2uaY1LrWP8() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8');
  if (_theframe) {
    ...
    if (vidyard_secure_vESKKQbggVjk2uaY1LrWP8 === true && vidyard_vESKKQbggVjk2uaY1LrWP8_params.type === 'lightbox') {
      vidyard_integration_check_vESKKQbggVjk2uaY1LrWP8();
    }
    ...
    if (vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_vESKKQbggVjk2uaY1LrWP8_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'vESKKQbggVjk2uaY1LrWP8';
      Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8')
...
function fn_vidyard_vESKKQbggVjk2uaY1LrWP8() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_vESKKQbggVjk2uaY1LrWP8 / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_vESKKQbggVjk2uaY1LrWP8(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_vESKKQbggVjk2uaY1LrWP8,
            vidyard_player_height_vESKKQbggVjk2uaY1LrWP8,
            319 + (vidyard_player_width_vESKKQbggVjk2uaY1LrWP8 / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8');
        var vidyard_span = document.getElementById('vidyard_span_vESKKQbggVjk2uaY1LrWP8');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('vESKKQbggVjk2uaY1LrWP8').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_vESKKQbggVjk2uaY1LrWP8,
    height: vidyard_player_height_vESKKQbggVjk2uaY1LrWP8,
    animate: !vidyard_html5_vESKKQbggVjk2uaY1LrWP8,
    fixed: true
  });
}
