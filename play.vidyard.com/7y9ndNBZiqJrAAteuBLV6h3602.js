var vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h = 640;
var vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h = 360;
var vidyard_html5_7y9ndNBZiqJrAAteuBLV6h = false;
var vidyard_secure_7y9ndNBZiqJrAAteuBLV6h = false;
var vidyard_integration_check_7y9ndNBZiqJrAAteuBLV6h = function() {};
var vidyard_7y9ndNBZiqJrAAteuBLV6h_params = {};
var vidyard_7y9ndNBZiqJrAAteuBLV6h_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_7y9ndNBZiqJrAAteuBLV6h');
  var playerDetails = {"keywords":"CLP,Controlador Micro,características gerais,controlador Micro800,controlador Micro870,programa aplicativo Micro,sistema de controle Micro,sistema de controle Micro para OEM,sistema de controle Micro para os fabricantes de máquinas","thumbnailUrl":"https://play.vidyard.com/7y9ndNBZiqJrAAteuBLV6h.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"7y9ndNBZiqJrAAteuBLV6h","description":"Apresentando o controlador Micro870, o último controlador expansível e poderoso dentro da família Micro800®. Desenvolvido para programas aplicativos de grandes máquinas autônomas, o controlador Micro870 vem com uma grande capacidade de memória para permitir um programa mais modular e o uso de funções definidas pelo usuário.\r\n\r\nPara saber mais sobre os controladores Micro870, visite:\r\nhttps://ab.rockwellautomation.com/pt/Programmable-Controllers/Micro870","name":"Conhecendo o controlador Micro870®","transcript":"","uploadDate":"2018-08-07T04:00:47.000Z","duration":"T1M41S","embedUrl":"https://play.vidyard.com/7y9ndNBZiqJrAAteuBLV6h","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_7y9ndNBZiqJrAAteuBLV6h") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_7y9ndNBZiqJrAAteuBLV6h();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/7y9ndNBZiqJrAAteuBLV6h.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_7y9ndNBZiqJrAAteuBLV6h_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_7y9ndNBZiqJrAAteuBLV6h_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_7y9ndNBZiqJrAAteuBLV6h_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_7y9ndNBZiqJrAAteuBLV6h = true;
          default:
            vidyard_7y9ndNBZiqJrAAteuBLV6h_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type || vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type !== 'lightbox') {
    vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_7y9ndNBZiqJrAAteuBLV6h_params.hide_html5_playlist !== 'undefined' && vidyard_7y9ndNBZiqJrAAteuBLV6h_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_7y9ndNBZiqJrAAteuBLV6h_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_7y9ndNBZiqJrAAteuBLV6h_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h = query_player_width;
    vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h) / vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h;
    vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h = query_player_width;
    vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h) / vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h;
    vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h = query_player_width;
    vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_7y9ndNBZiqJrAAteuBLV6h");
  ...
  if (!iframe_container && vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_7y9ndNBZiqJrAAteuBLV6h';
  ...
  if (vidyard_secure_7y9ndNBZiqJrAAteuBLV6h === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === '7y9ndNBZiqJrAAteuBLV6h') {
      vidyard_7y9ndNBZiqJrAAteuBLV6h_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_7y9ndNBZiqJrAAteuBLV6h = true;
    vidyard_7y9ndNBZiqJrAAteuBLV6h_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "7y9ndNBZiqJrAAteuBLV6h") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_7y9ndNBZiqJrAAteuBLV6h === true && vidyard_7y9ndNBZiqJrAAteuBLV6h_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h');
        var message = {
          'event': 'parentReferer',
          'uuid': '7y9ndNBZiqJrAAteuBLV6h',
          'data': {
            'value': vidyard_7y9ndNBZiqJrAAteuBLV6h_params.referring_url
          }
        }
      ...
      if (!vidyard_7y9ndNBZiqJrAAteuBLV6h_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_7y9ndNBZiqJrAAteuBLV6h_params.pardot_id = pardot_id;
      ...
      if (!vidyard_7y9ndNBZiqJrAAteuBLV6h_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_7y9ndNBZiqJrAAteuBLV6h_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_7y9ndNBZiqJrAAteuBLV6h_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_7y9ndNBZiqJrAAteuBLV6h_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_id = marketo_id;
      ...
      if (vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type === "inline" || vidyard_secure_7y9ndNBZiqJrAAteuBLV6h === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = '7y9ndNBZiqJrAAteuBLV6h';
          Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_7y9ndNBZiqJrAAteuBLV6h = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_7y9ndNBZiqJrAAteuBLV6h(false, vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h, vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_7y9ndNBZiqJrAAteuBLV6h();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h')
      );

    } else if (vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_7y9ndNBZiqJrAAteuBLV6h) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['7y9ndNBZiqJrAAteuBLV6h'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_7y9ndNBZiqJrAAteuBLV6h
  playerIframe = Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = '7y9ndNBZiqJrAAteuBLV6h';
...
(function () {
  function async_load() {
    var contactId = vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/7y9ndNBZiqJrAAteuBLV6h/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_7y9ndNBZiqJrAAteuBLV6h(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_7y9ndNBZiqJrAAteuBLV6h_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_7y9ndNBZiqJrAAteuBLV6h_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h');
  ...
  if (vidyard_secure_7y9ndNBZiqJrAAteuBLV6h === true) {
    query_params_string = vidyard_7y9ndNBZiqJrAAteuBLV6h_raw_params;
  } else {
    for (var param in vidyard_7y9ndNBZiqJrAAteuBLV6h_params) {
      var param_value = vidyard_7y9ndNBZiqJrAAteuBLV6h_params[param];
      if (param_value === true) {
        param_value = '1';
      }
...
function fn_vidyard_iframe_after_load_7y9ndNBZiqJrAAteuBLV6h() {
  ...
  if (_theframe) {
    ...
    if (vidyard_secure_7y9ndNBZiqJrAAteuBLV6h === true && vidyard_7y9ndNBZiqJrAAteuBLV6h_params.type === 'lightbox') {
      vidyard_integration_check_7y9ndNBZiqJrAAteuBLV6h();
    }
    ...
    if (vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_7y9ndNBZiqJrAAteuBLV6h_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = '7y9ndNBZiqJrAAteuBLV6h';
      Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h')
...
function fn_vidyard_7y9ndNBZiqJrAAteuBLV6h() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_7y9ndNBZiqJrAAteuBLV6h(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h,
            vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h,
            319 + (vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h');
        var vidyard_span = document.getElementById('vidyard_span_7y9ndNBZiqJrAAteuBLV6h');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('7y9ndNBZiqJrAAteuBLV6h').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_7y9ndNBZiqJrAAteuBLV6h,
    height: vidyard_player_height_7y9ndNBZiqJrAAteuBLV6h,
    animate: !vidyard_html5_7y9ndNBZiqJrAAteuBLV6h,
    fixed: true
  });
}
