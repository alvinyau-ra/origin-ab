var vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg = 640;
var vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg = 360;
var vidyard_html5_19ZL5GPUxzhaHo63ugQ3Zg = false;
var vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg = false;
var vidyard_integration_check_19ZL5GPUxzhaHo63ugQ3Zg = function() {};
var vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params = {};
var vidyard_19ZL5GPUxzhaHo63ugQ3Zg_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_19ZL5GPUxzhaHo63ugQ3Zg');
  var playerDetails = {"keywords":"","thumbnailUrl":"https://play.vidyard.com/19ZL5GPUxzhaHo63ugQ3Zg.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"19ZL5GPUxzhaHo63ugQ3Zg","description":"No description","name":"Hazardous Location Panels and Components for Class I, Div. 1","transcript":"","uploadDate":"2014-02-10T16:59:15.000Z","duration":"T3M41S","embedUrl":"https://play.vidyard.com/19ZL5GPUxzhaHo63ugQ3Zg","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_19ZL5GPUxzhaHo63ugQ3Zg") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_19ZL5GPUxzhaHo63ugQ3Zg();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/19ZL5GPUxzhaHo63ugQ3Zg.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_19ZL5GPUxzhaHo63ugQ3Zg_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg = true;
          default:
            vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type || vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type !== 'lightbox') {
    vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.hide_html5_playlist !== 'undefined' && vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg = query_player_width;
    vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg) / vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg;
    vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg = query_player_width;
    vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg) / vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg;
    vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg = query_player_width;
    vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_19ZL5GPUxzhaHo63ugQ3Zg");
  ...
  if (!iframe_container && vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_19ZL5GPUxzhaHo63ugQ3Zg';
  ...
  if (vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === '19ZL5GPUxzhaHo63ugQ3Zg') {
      vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_19ZL5GPUxzhaHo63ugQ3Zg = true;
    vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "19ZL5GPUxzhaHo63ugQ3Zg") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg === true && vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg');
        var message = {
          'event': 'parentReferer',
          'uuid': '19ZL5GPUxzhaHo63ugQ3Zg',
          'data': {
            'value': vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.referring_url
          }
        }
      ...
      if (!vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.pardot_id = pardot_id;
      ...
      if (!vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.eloqua_id &&
            ((vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg === true && vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === 'lightbox') ||
             (vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === "inline" || vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = '19ZL5GPUxzhaHo63ugQ3Zg';
          Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_19ZL5GPUxzhaHo63ugQ3Zg = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_19ZL5GPUxzhaHo63ugQ3Zg(false, vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg, vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_19ZL5GPUxzhaHo63ugQ3Zg();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg')
      );

    } else if (vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['19ZL5GPUxzhaHo63ugQ3Zg'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_19ZL5GPUxzhaHo63ugQ3Zg
  playerIframe = Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = '19ZL5GPUxzhaHo63ugQ3Zg';
...
(function () {
  function async_load() {
    var contactId = vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/19ZL5GPUxzhaHo63ugQ3Zg/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_19ZL5GPUxzhaHo63ugQ3Zg(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg');
  ...
  if (vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg === true) {
    query_params_string = vidyard_19ZL5GPUxzhaHo63ugQ3Zg_raw_params;
  } else {
    for (var param in vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params) {
      var param_value = vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_19ZL5GPUxzhaHo63ugQ3Zg" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_19ZL5GPUxzhaHo63ugQ3Zg" class="vidyard_iframe" src="//play.vidyard.com/19ZL5GPUxzhaHo63ugQ3Zg?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_19ZL5GPUxzhaHo63ugQ3Zg() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg');
  if (_theframe) {
    ...
    if (vidyard_secure_19ZL5GPUxzhaHo63ugQ3Zg === true && vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.type === 'lightbox') {
      vidyard_integration_check_19ZL5GPUxzhaHo63ugQ3Zg();
    }
    ...
    if (vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_19ZL5GPUxzhaHo63ugQ3Zg_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = '19ZL5GPUxzhaHo63ugQ3Zg';
      Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg')
...
function fn_vidyard_19ZL5GPUxzhaHo63ugQ3Zg() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_19ZL5GPUxzhaHo63ugQ3Zg(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg,
            vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg,
            319 + (vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg');
        var vidyard_span = document.getElementById('vidyard_span_19ZL5GPUxzhaHo63ugQ3Zg');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('19ZL5GPUxzhaHo63ugQ3Zg').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_19ZL5GPUxzhaHo63ugQ3Zg,
    height: vidyard_player_height_19ZL5GPUxzhaHo63ugQ3Zg,
    animate: !vidyard_html5_19ZL5GPUxzhaHo63ugQ3Zg,
    fixed: true
  });
}
