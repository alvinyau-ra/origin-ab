var vidyard_player_width_tNXXC4hC35NLNFytZGUvET = 640;
var vidyard_player_height_tNXXC4hC35NLNFytZGUvET = 360;
var vidyard_html5_tNXXC4hC35NLNFytZGUvET = false;
var vidyard_secure_tNXXC4hC35NLNFytZGUvET = false;
var vidyard_integration_check_tNXXC4hC35NLNFytZGUvET = function() {};
var vidyard_tNXXC4hC35NLNFytZGUvET_params = {};
var vidyard_tNXXC4hC35NLNFytZGUvET_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_tNXXC4hC35NLNFytZGUvET');
  var playerDetails = {"keywords":"FLEX 5000 I/O,Dezentrale E/A-Lösung,E/A-Module,FLEX I/O,Logix 5000-Serie,Sicherheits-E/A-Module,modular im Schaltschrank","thumbnailUrl":"https://play.vidyard.com/tNXXC4hC35NLNFytZGUvET.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"tNXXC4hC35NLNFytZGUvET","description":"Flexibilität für verschiedenste Anwendungen: Über eine verbesserte 1-GB-EtherNet/IP-Verbindung und flexible Installationsoptionen unterstützt FLEX 5000 I/O die Umsetzung eines Connected Enterprise, sodass Sie schneller mit intelligenter Steuerung auf Ihre Prozessanforderungen reagieren können.\r\n\r\nWeitere Informationen unter: https://ab.rockwellautomation.com/de/IO/In-Cabinet-Modular/FLEX-5000-IO-Modules","name":"FLEX 5000™ I/O: Überblick","transcript":"","uploadDate":"2018-08-01T02:48:40.000Z","duration":"T3M52S","embedUrl":"https://play.vidyard.com/tNXXC4hC35NLNFytZGUvET","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_tNXXC4hC35NLNFytZGUvET") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_tNXXC4hC35NLNFytZGUvET();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/tNXXC4hC35NLNFytZGUvET.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_tNXXC4hC35NLNFytZGUvET_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_tNXXC4hC35NLNFytZGUvET_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_tNXXC4hC35NLNFytZGUvET_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_tNXXC4hC35NLNFytZGUvET = true;
          default:
            vidyard_tNXXC4hC35NLNFytZGUvET_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_tNXXC4hC35NLNFytZGUvET_params.type || vidyard_tNXXC4hC35NLNFytZGUvET_params.type !== 'lightbox') {
    vidyard_tNXXC4hC35NLNFytZGUvET_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_tNXXC4hC35NLNFytZGUvET_params.hide_html5_playlist !== 'undefined' && vidyard_tNXXC4hC35NLNFytZGUvET_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_tNXXC4hC35NLNFytZGUvET_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_tNXXC4hC35NLNFytZGUvET_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_tNXXC4hC35NLNFytZGUvET = query_player_width;
    vidyard_player_height_tNXXC4hC35NLNFytZGUvET = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_tNXXC4hC35NLNFytZGUvET) / vidyard_player_width_tNXXC4hC35NLNFytZGUvET;
    vidyard_player_width_tNXXC4hC35NLNFytZGUvET = query_player_width;
    vidyard_player_height_tNXXC4hC35NLNFytZGUvET = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_tNXXC4hC35NLNFytZGUvET) / vidyard_player_height_tNXXC4hC35NLNFytZGUvET;
    vidyard_player_width_tNXXC4hC35NLNFytZGUvET = query_player_width;
    vidyard_player_height_tNXXC4hC35NLNFytZGUvET = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_tNXXC4hC35NLNFytZGUvET");
  ...
  if (!iframe_container && vidyard_tNXXC4hC35NLNFytZGUvET_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_tNXXC4hC35NLNFytZGUvET';
  ...
  if (vidyard_secure_tNXXC4hC35NLNFytZGUvET === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'tNXXC4hC35NLNFytZGUvET') {
      vidyard_tNXXC4hC35NLNFytZGUvET_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_tNXXC4hC35NLNFytZGUvET = true;
    vidyard_tNXXC4hC35NLNFytZGUvET_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "tNXXC4hC35NLNFytZGUvET") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_tNXXC4hC35NLNFytZGUvET === true && vidyard_tNXXC4hC35NLNFytZGUvET_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET');
        var message = {
          'event': 'parentReferer',
          'uuid': 'tNXXC4hC35NLNFytZGUvET',
          'data': {
            'value': vidyard_tNXXC4hC35NLNFytZGUvET_params.referring_url
          }
        }
      ...
      if (!vidyard_tNXXC4hC35NLNFytZGUvET_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_tNXXC4hC35NLNFytZGUvET_params.pardot_id = pardot_id;
      ...
      if (!vidyard_tNXXC4hC35NLNFytZGUvET_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_tNXXC4hC35NLNFytZGUvET_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_tNXXC4hC35NLNFytZGUvET_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_tNXXC4hC35NLNFytZGUvET_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_id = marketo_id;
      ...
      if (vidyard_tNXXC4hC35NLNFytZGUvET_params.type === "inline" || vidyard_secure_tNXXC4hC35NLNFytZGUvET === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'tNXXC4hC35NLNFytZGUvET';
          Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_tNXXC4hC35NLNFytZGUvET = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_tNXXC4hC35NLNFytZGUvET_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_tNXXC4hC35NLNFytZGUvET(false, vidyard_player_width_tNXXC4hC35NLNFytZGUvET, vidyard_player_height_tNXXC4hC35NLNFytZGUvET);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_tNXXC4hC35NLNFytZGUvET();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET')
      );

    } else if (vidyard_tNXXC4hC35NLNFytZGUvET_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_tNXXC4hC35NLNFytZGUvET) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['tNXXC4hC35NLNFytZGUvET'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_tNXXC4hC35NLNFytZGUvET
  playerIframe = Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'tNXXC4hC35NLNFytZGUvET';
...
(function () {
  function async_load() {
    var contactId = vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/tNXXC4hC35NLNFytZGUvET/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_tNXXC4hC35NLNFytZGUvET(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_tNXXC4hC35NLNFytZGUvET_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_tNXXC4hC35NLNFytZGUvET_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET');
  ...
  if (vidyard_secure_tNXXC4hC35NLNFytZGUvET === true) {
    query_params_string = vidyard_tNXXC4hC35NLNFytZGUvET_raw_params;
  } else {
    for (var param in vidyard_tNXXC4hC35NLNFytZGUvET_params) {
      var param_value = vidyard_tNXXC4hC35NLNFytZGUvET_params[param];
      if (param_value === true) {
        param_value = '1';
      }
...
function fn_vidyard_iframe_after_load_tNXXC4hC35NLNFytZGUvET() {
  ...
  if (_theframe) {
    ...
    if (vidyard_secure_tNXXC4hC35NLNFytZGUvET === true && vidyard_tNXXC4hC35NLNFytZGUvET_params.type === 'lightbox') {
      vidyard_integration_check_tNXXC4hC35NLNFytZGUvET();
    }
    ...
    if (vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_tNXXC4hC35NLNFytZGUvET_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'tNXXC4hC35NLNFytZGUvET';
      Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET')
...
function fn_vidyard_tNXXC4hC35NLNFytZGUvET() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_tNXXC4hC35NLNFytZGUvET / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_tNXXC4hC35NLNFytZGUvET(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_tNXXC4hC35NLNFytZGUvET,
            vidyard_player_height_tNXXC4hC35NLNFytZGUvET,
            319 + (vidyard_player_width_tNXXC4hC35NLNFytZGUvET / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET');
        var vidyard_span = document.getElementById('vidyard_span_tNXXC4hC35NLNFytZGUvET');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('tNXXC4hC35NLNFytZGUvET').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_tNXXC4hC35NLNFytZGUvET,
    height: vidyard_player_height_tNXXC4hC35NLNFytZGUvET,
    animate: !vidyard_html5_tNXXC4hC35NLNFytZGUvET,
    fixed: true
  });
}
