var vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw = 640;
var vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw = 360;
var vidyard_html5_MJtCRI4mAZS5COOdgTNZaw = false;
var vidyard_secure_MJtCRI4mAZS5COOdgTNZaw = false;
var vidyard_integration_check_MJtCRI4mAZS5COOdgTNZaw = function() {};
var vidyard_MJtCRI4mAZS5COOdgTNZaw_params = {};
var vidyard_MJtCRI4mAZS5COOdgTNZaw_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_MJtCRI4mAZS5COOdgTNZaw');
  var playerDetails = {"keywords":"","thumbnailUrl":"https://play.vidyard.com/MJtCRI4mAZS5COOdgTNZaw.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"MJtCRI4mAZS5COOdgTNZaw","description":"1771 I/O to ControlLogix 1756 I/O Wiring Conversion System","name":"1771 I/O to ControlLogix 1756 I/O Wiring Conversion System","transcript":"","uploadDate":"2014-11-14T19:53:31.000Z","duration":"T1M22S","embedUrl":"https://play.vidyard.com/MJtCRI4mAZS5COOdgTNZaw","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_MJtCRI4mAZS5COOdgTNZaw") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_MJtCRI4mAZS5COOdgTNZaw();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/MJtCRI4mAZS5COOdgTNZaw.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_MJtCRI4mAZS5COOdgTNZaw_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_MJtCRI4mAZS5COOdgTNZaw_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_MJtCRI4mAZS5COOdgTNZaw_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_MJtCRI4mAZS5COOdgTNZaw = true;
          default:
            vidyard_MJtCRI4mAZS5COOdgTNZaw_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type || vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type !== 'lightbox') {
    vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_MJtCRI4mAZS5COOdgTNZaw_params.hide_html5_playlist !== 'undefined' && vidyard_MJtCRI4mAZS5COOdgTNZaw_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_MJtCRI4mAZS5COOdgTNZaw_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_MJtCRI4mAZS5COOdgTNZaw_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw = query_player_width;
    vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw) / vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw;
    vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw = query_player_width;
    vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw) / vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw;
    vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw = query_player_width;
    vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_MJtCRI4mAZS5COOdgTNZaw");
  ...
  if (!iframe_container && vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_MJtCRI4mAZS5COOdgTNZaw';
  ...
  if (vidyard_secure_MJtCRI4mAZS5COOdgTNZaw === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'MJtCRI4mAZS5COOdgTNZaw') {
      vidyard_MJtCRI4mAZS5COOdgTNZaw_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_MJtCRI4mAZS5COOdgTNZaw = true;
    vidyard_MJtCRI4mAZS5COOdgTNZaw_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "MJtCRI4mAZS5COOdgTNZaw") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_MJtCRI4mAZS5COOdgTNZaw === true && vidyard_MJtCRI4mAZS5COOdgTNZaw_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw');
        var message = {
          'event': 'parentReferer',
          'uuid': 'MJtCRI4mAZS5COOdgTNZaw',
          'data': {
            'value': vidyard_MJtCRI4mAZS5COOdgTNZaw_params.referring_url
          }
        }
      ...
      if (!vidyard_MJtCRI4mAZS5COOdgTNZaw_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_MJtCRI4mAZS5COOdgTNZaw_params.pardot_id = pardot_id;
      ...
      if (!vidyard_MJtCRI4mAZS5COOdgTNZaw_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_MJtCRI4mAZS5COOdgTNZaw_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_MJtCRI4mAZS5COOdgTNZaw_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_MJtCRI4mAZS5COOdgTNZaw_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_MJtCRI4mAZS5COOdgTNZaw_params.eloqua_id &&
            ((vidyard_secure_MJtCRI4mAZS5COOdgTNZaw === true && vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === 'lightbox') ||
             (vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_MJtCRI4mAZS5COOdgTNZaw_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === "inline" || vidyard_secure_MJtCRI4mAZS5COOdgTNZaw === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'MJtCRI4mAZS5COOdgTNZaw';
          Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_MJtCRI4mAZS5COOdgTNZaw = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_MJtCRI4mAZS5COOdgTNZaw(false, vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw, vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_MJtCRI4mAZS5COOdgTNZaw();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw')
      );

    } else if (vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_MJtCRI4mAZS5COOdgTNZaw) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_MJtCRI4mAZS5COOdgTNZaw_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['MJtCRI4mAZS5COOdgTNZaw'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_MJtCRI4mAZS5COOdgTNZaw
  playerIframe = Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'MJtCRI4mAZS5COOdgTNZaw';
...
(function () {
  function async_load() {
    var contactId = vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/MJtCRI4mAZS5COOdgTNZaw/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_MJtCRI4mAZS5COOdgTNZaw(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_MJtCRI4mAZS5COOdgTNZaw_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_MJtCRI4mAZS5COOdgTNZaw_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw');
  ...
  if (vidyard_secure_MJtCRI4mAZS5COOdgTNZaw === true) {
    query_params_string = vidyard_MJtCRI4mAZS5COOdgTNZaw_raw_params;
  } else {
    for (var param in vidyard_MJtCRI4mAZS5COOdgTNZaw_params) {
      var param_value = vidyard_MJtCRI4mAZS5COOdgTNZaw_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_MJtCRI4mAZS5COOdgTNZaw" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_MJtCRI4mAZS5COOdgTNZaw" class="vidyard_iframe" src="//play.vidyard.com/MJtCRI4mAZS5COOdgTNZaw?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_MJtCRI4mAZS5COOdgTNZaw() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw');
  if (_theframe) {
    ...
    if (vidyard_secure_MJtCRI4mAZS5COOdgTNZaw === true && vidyard_MJtCRI4mAZS5COOdgTNZaw_params.type === 'lightbox') {
      vidyard_integration_check_MJtCRI4mAZS5COOdgTNZaw();
    }
    ...
    if (vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_MJtCRI4mAZS5COOdgTNZaw_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'MJtCRI4mAZS5COOdgTNZaw';
      Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw')
...
function fn_vidyard_MJtCRI4mAZS5COOdgTNZaw() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_MJtCRI4mAZS5COOdgTNZaw(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw,
            vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw,
            319 + (vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw');
        var vidyard_span = document.getElementById('vidyard_span_MJtCRI4mAZS5COOdgTNZaw');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('MJtCRI4mAZS5COOdgTNZaw').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_MJtCRI4mAZS5COOdgTNZaw,
    height: vidyard_player_height_MJtCRI4mAZS5COOdgTNZaw,
    animate: !vidyard_html5_MJtCRI4mAZS5COOdgTNZaw,
    fixed: true
  });
}
