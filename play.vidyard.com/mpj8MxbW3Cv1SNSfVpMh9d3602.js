var vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d = 640;
var vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d = 360;
var vidyard_html5_mpj8MxbW3Cv1SNSfVpMh9d = false;
var vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d = false;
var vidyard_integration_check_mpj8MxbW3Cv1SNSfVpMh9d = function() {};
var vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params = {};
var vidyard_mpj8MxbW3Cv1SNSfVpMh9d_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_mpj8MxbW3Cv1SNSfVpMh9d');
  var playerDetails = {"keywords":"固态,基于微处理器,急停开关,最高安全等级","thumbnailUrl":"https://play.vidyard.com/mpj8MxbW3Cv1SNSfVpMh9d.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"mpj8MxbW3Cv1SNSfVpMh9d","description":"借助 Guardmaster Lifeline™ 5 拉绳开关的诊断功能，您可在潜在问题导致计划外停机前就解决它们。https://ab.rockwellautomation.com/zh/push-buttons/emergency-stop/cable-pull/lifeline-5","name":"Guardmaster® Lifeline 5 拉绳开关视频","transcript":"","uploadDate":"2018-01-17T20:37:37.000Z","duration":"T2M25S","embedUrl":"https://play.vidyard.com/mpj8MxbW3Cv1SNSfVpMh9d","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_mpj8MxbW3Cv1SNSfVpMh9d") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_mpj8MxbW3Cv1SNSfVpMh9d();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/mpj8MxbW3Cv1SNSfVpMh9d.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_mpj8MxbW3Cv1SNSfVpMh9d_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d = true;
          default:
            vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type || vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type !== 'lightbox') {
    vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.hide_html5_playlist !== 'undefined' && vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d = query_player_width;
    vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d) / vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d;
    vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d = query_player_width;
    vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d) / vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d;
    vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d = query_player_width;
    vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_mpj8MxbW3Cv1SNSfVpMh9d");
  ...
  if (!iframe_container && vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_mpj8MxbW3Cv1SNSfVpMh9d';
  ...
  if (vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'mpj8MxbW3Cv1SNSfVpMh9d') {
      vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_mpj8MxbW3Cv1SNSfVpMh9d = true;
    vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "mpj8MxbW3Cv1SNSfVpMh9d") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d === true && vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d');
        var message = {
          'event': 'parentReferer',
          'uuid': 'mpj8MxbW3Cv1SNSfVpMh9d',
          'data': {
            'value': vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.referring_url
          }
        }
      ...
      if (!vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.pardot_id = pardot_id;
      ...
      if (!vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.eloqua_id &&
            ((vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d === true && vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === 'lightbox') ||
             (vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === "inline" || vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'mpj8MxbW3Cv1SNSfVpMh9d';
          Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_mpj8MxbW3Cv1SNSfVpMh9d = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_mpj8MxbW3Cv1SNSfVpMh9d(false, vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d, vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_mpj8MxbW3Cv1SNSfVpMh9d();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d')
      );

    } else if (vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['mpj8MxbW3Cv1SNSfVpMh9d'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_mpj8MxbW3Cv1SNSfVpMh9d
  playerIframe = Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'mpj8MxbW3Cv1SNSfVpMh9d';
...
(function () {
  function async_load() {
    var contactId = vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/mpj8MxbW3Cv1SNSfVpMh9d/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_mpj8MxbW3Cv1SNSfVpMh9d(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d');
  ...
  if (vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d === true) {
    query_params_string = vidyard_mpj8MxbW3Cv1SNSfVpMh9d_raw_params;
  } else {
    for (var param in vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params) {
      var param_value = vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params[param];
      if (param_value === true) {
        param_value = '1';
      }
...
function fn_vidyard_iframe_after_load_mpj8MxbW3Cv1SNSfVpMh9d() {
  ...
  if (_theframe) {
    ...
    if (vidyard_secure_mpj8MxbW3Cv1SNSfVpMh9d === true && vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.type === 'lightbox') {
      vidyard_integration_check_mpj8MxbW3Cv1SNSfVpMh9d();
    }
    ...
    if (vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_mpj8MxbW3Cv1SNSfVpMh9d_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'mpj8MxbW3Cv1SNSfVpMh9d';
      Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d')
...
function fn_vidyard_mpj8MxbW3Cv1SNSfVpMh9d() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_mpj8MxbW3Cv1SNSfVpMh9d(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d,
            vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d,
            319 + (vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d');
        var vidyard_span = document.getElementById('vidyard_span_mpj8MxbW3Cv1SNSfVpMh9d');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('mpj8MxbW3Cv1SNSfVpMh9d').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_mpj8MxbW3Cv1SNSfVpMh9d,
    height: vidyard_player_height_mpj8MxbW3Cv1SNSfVpMh9d,
    animate: !vidyard_html5_mpj8MxbW3Cv1SNSfVpMh9d,
    fixed: true
  });
}
