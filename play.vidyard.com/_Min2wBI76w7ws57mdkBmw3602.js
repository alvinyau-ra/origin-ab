var vidyard_player_width__Min2wBI76w7ws57mdkBmw = 848;
var vidyard_player_height__Min2wBI76w7ws57mdkBmw = 477;
var vidyard_html5__Min2wBI76w7ws57mdkBmw = false;
var vidyard_secure__Min2wBI76w7ws57mdkBmw = false;
var vidyard_integration_check__Min2wBI76w7ws57mdkBmw = function() {};
var vidyard__Min2wBI76w7ws57mdkBmw_params = {};
var vidyard__Min2wBI76w7ws57mdkBmw_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code__Min2wBI76w7ws57mdkBmw');
  var playerDetails = {"keywords":"On-Machine,Stratix,IP67,Industrial Ethernet Switch","thumbnailUrl":"https://play.vidyard.com/_Min2wBI76w7ws57mdkBmw.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"_Min2wBI76w7ws57mdkBmw","description":"Expanding the Stratix™ Portfolio to the On-Machine™ Space for Connectivity in Harsh Environments\r\n","name":"ArmorStratix 5700 Industrial Switch","transcript":"","uploadDate":"2014-08-05T18:49:55.000Z","duration":"T0M54S","embedUrl":"https://play.vidyard.com/_Min2wBI76w7ws57mdkBmw","height":477,"width":848};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code__Min2wBI76w7ws57mdkBmw") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard__Min2wBI76w7ws57mdkBmw();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/_Min2wBI76w7ws57mdkBmw.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard__Min2wBI76w7ws57mdkBmw_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard__Min2wBI76w7ws57mdkBmw_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard__Min2wBI76w7ws57mdkBmw_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure__Min2wBI76w7ws57mdkBmw = true;
          default:
            vidyard__Min2wBI76w7ws57mdkBmw_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard__Min2wBI76w7ws57mdkBmw_params.type || vidyard__Min2wBI76w7ws57mdkBmw_params.type !== 'lightbox') {
    vidyard__Min2wBI76w7ws57mdkBmw_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard__Min2wBI76w7ws57mdkBmw_params.hide_html5_playlist !== 'undefined' && vidyard__Min2wBI76w7ws57mdkBmw_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard__Min2wBI76w7ws57mdkBmw_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard__Min2wBI76w7ws57mdkBmw_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width__Min2wBI76w7ws57mdkBmw = query_player_width;
    vidyard_player_height__Min2wBI76w7ws57mdkBmw = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height__Min2wBI76w7ws57mdkBmw) / vidyard_player_width__Min2wBI76w7ws57mdkBmw;
    vidyard_player_width__Min2wBI76w7ws57mdkBmw = query_player_width;
    vidyard_player_height__Min2wBI76w7ws57mdkBmw = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width__Min2wBI76w7ws57mdkBmw) / vidyard_player_height__Min2wBI76w7ws57mdkBmw;
    vidyard_player_width__Min2wBI76w7ws57mdkBmw = query_player_width;
    vidyard_player_height__Min2wBI76w7ws57mdkBmw = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard__Min2wBI76w7ws57mdkBmw");
  ...
  if (!iframe_container && vidyard__Min2wBI76w7ws57mdkBmw_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard__Min2wBI76w7ws57mdkBmw';
  ...
  if (vidyard_secure__Min2wBI76w7ws57mdkBmw === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard__Min2wBI76w7ws57mdkBmw_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard__Min2wBI76w7ws57mdkBmw_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard__Min2wBI76w7ws57mdkBmw_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard__Min2wBI76w7ws57mdkBmw_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard__Min2wBI76w7ws57mdkBmw_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === '_Min2wBI76w7ws57mdkBmw') {
      vidyard__Min2wBI76w7ws57mdkBmw_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5__Min2wBI76w7ws57mdkBmw = true;
    vidyard__Min2wBI76w7ws57mdkBmw_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "_Min2wBI76w7ws57mdkBmw") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure__Min2wBI76w7ws57mdkBmw === true && vidyard__Min2wBI76w7ws57mdkBmw_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw');
        var message = {
          'event': 'parentReferer',
          'uuid': '_Min2wBI76w7ws57mdkBmw',
          'data': {
            'value': vidyard__Min2wBI76w7ws57mdkBmw_params.referring_url
          }
        }
      ...
      if (!vidyard__Min2wBI76w7ws57mdkBmw_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard__Min2wBI76w7ws57mdkBmw_params.pardot_id = pardot_id;
      ...
      if (!vidyard__Min2wBI76w7ws57mdkBmw_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard__Min2wBI76w7ws57mdkBmw_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard__Min2wBI76w7ws57mdkBmw_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard__Min2wBI76w7ws57mdkBmw_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard__Min2wBI76w7ws57mdkBmw_params.eloqua_id &&
            ((vidyard_secure__Min2wBI76w7ws57mdkBmw === true && vidyard__Min2wBI76w7ws57mdkBmw_params.type === 'lightbox') ||
             (vidyard__Min2wBI76w7ws57mdkBmw_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard__Min2wBI76w7ws57mdkBmw_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard__Min2wBI76w7ws57mdkBmw_params.type === "inline" || vidyard_secure__Min2wBI76w7ws57mdkBmw === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = '_Min2wBI76w7ws57mdkBmw';
          Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check__Min2wBI76w7ws57mdkBmw = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard__Min2wBI76w7ws57mdkBmw_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe__Min2wBI76w7ws57mdkBmw(false, vidyard_player_width__Min2wBI76w7ws57mdkBmw, vidyard_player_height__Min2wBI76w7ws57mdkBmw);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load__Min2wBI76w7ws57mdkBmw();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw')
      );

    } else if (vidyard__Min2wBI76w7ws57mdkBmw_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure__Min2wBI76w7ws57mdkBmw) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard__Min2wBI76w7ws57mdkBmw_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['_Min2wBI76w7ws57mdkBmw'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load__Min2wBI76w7ws57mdkBmw
  playerIframe = Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = '_Min2wBI76w7ws57mdkBmw';
...
(function () {
  function async_load() {
    var contactId = vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/_Min2wBI76w7ws57mdkBmw/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe__Min2wBI76w7ws57mdkBmw(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard__Min2wBI76w7ws57mdkBmw_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard__Min2wBI76w7ws57mdkBmw_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw');
  ...
  if (vidyard_secure__Min2wBI76w7ws57mdkBmw === true) {
    query_params_string = vidyard__Min2wBI76w7ws57mdkBmw_raw_params;
  } else {
    for (var param in vidyard__Min2wBI76w7ws57mdkBmw_params) {
      var param_value = vidyard__Min2wBI76w7ws57mdkBmw_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span__Min2wBI76w7ws57mdkBmw" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe__Min2wBI76w7ws57mdkBmw" class="vidyard_iframe" src="//play.vidyard.com/_Min2wBI76w7ws57mdkBmw?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load__Min2wBI76w7ws57mdkBmw() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw');
  if (_theframe) {
    ...
    if (vidyard_secure__Min2wBI76w7ws57mdkBmw === true && vidyard__Min2wBI76w7ws57mdkBmw_params.type === 'lightbox') {
      vidyard_integration_check__Min2wBI76w7ws57mdkBmw();
    }
    ...
    if (vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard__Min2wBI76w7ws57mdkBmw_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = '_Min2wBI76w7ws57mdkBmw';
      Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw')
...
function fn_vidyard__Min2wBI76w7ws57mdkBmw() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width__Min2wBI76w7ws57mdkBmw / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe__Min2wBI76w7ws57mdkBmw(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width__Min2wBI76w7ws57mdkBmw,
            vidyard_player_height__Min2wBI76w7ws57mdkBmw,
            319 + (vidyard_player_width__Min2wBI76w7ws57mdkBmw / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw');
        var vidyard_span = document.getElementById('vidyard_span__Min2wBI76w7ws57mdkBmw');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('_Min2wBI76w7ws57mdkBmw').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width__Min2wBI76w7ws57mdkBmw,
    height: vidyard_player_height__Min2wBI76w7ws57mdkBmw,
    animate: !vidyard_html5__Min2wBI76w7ws57mdkBmw,
    fixed: true
  });
}
