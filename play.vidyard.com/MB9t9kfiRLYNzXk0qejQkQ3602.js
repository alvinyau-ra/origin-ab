var vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ = 640;
var vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ = 360;
var vidyard_html5_MB9t9kfiRLYNzXk0qejQkQ = false;
var vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ = false;
var vidyard_integration_check_MB9t9kfiRLYNzXk0qejQkQ = function() {};
var vidyard_MB9t9kfiRLYNzXk0qejQkQ_params = {};
var vidyard_MB9t9kfiRLYNzXk0qejQkQ_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_MB9t9kfiRLYNzXk0qejQkQ');
  var playerDetails = {"keywords":"armorstart,on machine solutions,Rockwell Automation,armorstart lt,armorconnect,distributed motor control,conveyor,decentralized,ethernet ip,reduced installation time,reduced installation cost,group motor,modular,quick disconnect,distributed IO,quick disconnects","thumbnailUrl":"https://play.vidyard.com/MB9t9kfiRLYNzXk0qejQkQ.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"MB9t9kfiRLYNzXk0qejQkQ","description":"Rockwell Automation presents On-Machine Solutions, outlining the key benefits and ideal applications of distributed motor control.","name":"On-Machine Solutions","transcript":"","uploadDate":"2015-02-05T19:52:11.000Z","duration":"T1M36S","embedUrl":"https://play.vidyard.com/MB9t9kfiRLYNzXk0qejQkQ","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_MB9t9kfiRLYNzXk0qejQkQ") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_MB9t9kfiRLYNzXk0qejQkQ();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/MB9t9kfiRLYNzXk0qejQkQ.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_MB9t9kfiRLYNzXk0qejQkQ_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_MB9t9kfiRLYNzXk0qejQkQ_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_MB9t9kfiRLYNzXk0qejQkQ_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ = true;
          default:
            vidyard_MB9t9kfiRLYNzXk0qejQkQ_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type || vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type !== 'lightbox') {
    vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.hide_html5_playlist !== 'undefined' && vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ = query_player_width;
    vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ) / vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ;
    vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ = query_player_width;
    vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ) / vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ;
    vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ = query_player_width;
    vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_MB9t9kfiRLYNzXk0qejQkQ");
  ...
  if (!iframe_container && vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_MB9t9kfiRLYNzXk0qejQkQ';
  ...
  if (vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'MB9t9kfiRLYNzXk0qejQkQ') {
      vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_MB9t9kfiRLYNzXk0qejQkQ = true;
    vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "MB9t9kfiRLYNzXk0qejQkQ") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ === true && vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ');
        var message = {
          'event': 'parentReferer',
          'uuid': 'MB9t9kfiRLYNzXk0qejQkQ',
          'data': {
            'value': vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.referring_url
          }
        }
      ...
      if (!vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.pardot_id = pardot_id;
      ...
      if (!vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.eloqua_id &&
            ((vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ === true && vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === 'lightbox') ||
             (vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === "inline" || vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'MB9t9kfiRLYNzXk0qejQkQ';
          Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_MB9t9kfiRLYNzXk0qejQkQ = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_MB9t9kfiRLYNzXk0qejQkQ(false, vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ, vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_MB9t9kfiRLYNzXk0qejQkQ();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ')
      );

    } else if (vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['MB9t9kfiRLYNzXk0qejQkQ'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_MB9t9kfiRLYNzXk0qejQkQ
  playerIframe = Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'MB9t9kfiRLYNzXk0qejQkQ';
...
(function () {
  function async_load() {
    var contactId = vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/MB9t9kfiRLYNzXk0qejQkQ/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_MB9t9kfiRLYNzXk0qejQkQ(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ');
  ...
  if (vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ === true) {
    query_params_string = vidyard_MB9t9kfiRLYNzXk0qejQkQ_raw_params;
  } else {
    for (var param in vidyard_MB9t9kfiRLYNzXk0qejQkQ_params) {
      var param_value = vidyard_MB9t9kfiRLYNzXk0qejQkQ_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_MB9t9kfiRLYNzXk0qejQkQ" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_MB9t9kfiRLYNzXk0qejQkQ" class="vidyard_iframe" src="//play.vidyard.com/MB9t9kfiRLYNzXk0qejQkQ?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_MB9t9kfiRLYNzXk0qejQkQ() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ');
  if (_theframe) {
    ...
    if (vidyard_secure_MB9t9kfiRLYNzXk0qejQkQ === true && vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.type === 'lightbox') {
      vidyard_integration_check_MB9t9kfiRLYNzXk0qejQkQ();
    }
    ...
    if (vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_MB9t9kfiRLYNzXk0qejQkQ_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'MB9t9kfiRLYNzXk0qejQkQ';
      Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ')
...
function fn_vidyard_MB9t9kfiRLYNzXk0qejQkQ() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_MB9t9kfiRLYNzXk0qejQkQ(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ,
            vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ,
            319 + (vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ');
        var vidyard_span = document.getElementById('vidyard_span_MB9t9kfiRLYNzXk0qejQkQ');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('MB9t9kfiRLYNzXk0qejQkQ').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_MB9t9kfiRLYNzXk0qejQkQ,
    height: vidyard_player_height_MB9t9kfiRLYNzXk0qejQkQ,
    animate: !vidyard_html5_MB9t9kfiRLYNzXk0qejQkQ,
    fixed: true
  });
}
