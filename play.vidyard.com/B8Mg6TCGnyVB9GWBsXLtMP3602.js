var vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP = 640;
var vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP = 360;
var vidyard_html5_B8Mg6TCGnyVB9GWBsXLtMP = false;
var vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP = false;
var vidyard_integration_check_B8Mg6TCGnyVB9GWBsXLtMP = function() {};
var vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params = {};
var vidyard_B8Mg6TCGnyVB9GWBsXLtMP_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_B8Mg6TCGnyVB9GWBsXLtMP');
  var playerDetails = {"keywords":"Micro800 控制器,Micro870 控制器,PLC,微型应用程序,微型控制器,微型控制系统,概述,针对 OEM 的微型控制系统,针对机器制造商的微型控制系统","thumbnailUrl":"https://play.vidyard.com/B8Mg6TCGnyVB9GWBsXLtMP.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"B8Mg6TCGnyVB9GWBsXLtMP","description":"介绍 Micro800® 系列中强大且可扩展的最新控制器 Micro870®。Micro870 控制器专用于大型单机机器应用，其内存容量大，可实现更多模块化程序，并支持用户自定义功能块。\r\n\r\n要了解有关 Micro870 控制器的更多信息，请访问：\r\nhttps://ab.rockwellautomation.com/zh/Programmable-Controllers/Micro870","name":"Micro870® 控制器概述","transcript":"","uploadDate":"2018-08-07T04:32:29.000Z","duration":"T1M41S","embedUrl":"https://play.vidyard.com/B8Mg6TCGnyVB9GWBsXLtMP","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_B8Mg6TCGnyVB9GWBsXLtMP") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_B8Mg6TCGnyVB9GWBsXLtMP();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/B8Mg6TCGnyVB9GWBsXLtMP.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_B8Mg6TCGnyVB9GWBsXLtMP_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP = true;
          default:
            vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type || vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type !== 'lightbox') {
    vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.hide_html5_playlist !== 'undefined' && vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP = query_player_width;
    vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP) / vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP;
    vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP = query_player_width;
    vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP) / vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP;
    vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP = query_player_width;
    vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_B8Mg6TCGnyVB9GWBsXLtMP");
  ...
  if (!iframe_container && vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_B8Mg6TCGnyVB9GWBsXLtMP';
  ...
  if (vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'B8Mg6TCGnyVB9GWBsXLtMP') {
      vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_B8Mg6TCGnyVB9GWBsXLtMP = true;
    vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "B8Mg6TCGnyVB9GWBsXLtMP") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP === true && vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP');
        var message = {
          'event': 'parentReferer',
          'uuid': 'B8Mg6TCGnyVB9GWBsXLtMP',
          'data': {
            'value': vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.referring_url
          }
        }
      ...
      if (!vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.pardot_id = pardot_id;
      ...
      if (!vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_id = marketo_id;
      ...
      if (vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type === "inline" || vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'B8Mg6TCGnyVB9GWBsXLtMP';
          Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_B8Mg6TCGnyVB9GWBsXLtMP = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_B8Mg6TCGnyVB9GWBsXLtMP(false, vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP, vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_B8Mg6TCGnyVB9GWBsXLtMP();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP')
      );

    } else if (vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['B8Mg6TCGnyVB9GWBsXLtMP'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_B8Mg6TCGnyVB9GWBsXLtMP
  playerIframe = Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'B8Mg6TCGnyVB9GWBsXLtMP';
...
(function () {
  function async_load() {
    var contactId = vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/B8Mg6TCGnyVB9GWBsXLtMP/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_B8Mg6TCGnyVB9GWBsXLtMP(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP');
  ...
  if (vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP === true) {
    query_params_string = vidyard_B8Mg6TCGnyVB9GWBsXLtMP_raw_params;
  } else {
    for (var param in vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params) {
      var param_value = vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params[param];
      if (param_value === true) {
        param_value = '1';
      }
...
function fn_vidyard_iframe_after_load_B8Mg6TCGnyVB9GWBsXLtMP() {
  ...
  if (_theframe) {
    ...
    if (vidyard_secure_B8Mg6TCGnyVB9GWBsXLtMP === true && vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.type === 'lightbox') {
      vidyard_integration_check_B8Mg6TCGnyVB9GWBsXLtMP();
    }
    ...
    if (vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_B8Mg6TCGnyVB9GWBsXLtMP_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'B8Mg6TCGnyVB9GWBsXLtMP';
      Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP')
...
function fn_vidyard_B8Mg6TCGnyVB9GWBsXLtMP() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_B8Mg6TCGnyVB9GWBsXLtMP(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP,
            vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP,
            319 + (vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP');
        var vidyard_span = document.getElementById('vidyard_span_B8Mg6TCGnyVB9GWBsXLtMP');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('B8Mg6TCGnyVB9GWBsXLtMP').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_B8Mg6TCGnyVB9GWBsXLtMP,
    height: vidyard_player_height_B8Mg6TCGnyVB9GWBsXLtMP,
    animate: !vidyard_html5_B8Mg6TCGnyVB9GWBsXLtMP,
    fixed: true
  });
}
