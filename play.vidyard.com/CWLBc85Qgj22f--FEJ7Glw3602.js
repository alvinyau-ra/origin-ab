var vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw = 640;
var vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw = 360;
var vidyard_html5_CWLBc85Qgj22f$$FEJ7Glw = false;
var vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw = false;
var vidyard_integration_check_CWLBc85Qgj22f$$FEJ7Glw = function() {};
var vidyard_CWLBc85Qgj22f$$FEJ7Glw_params = {};
var vidyard_CWLBc85Qgj22f$$FEJ7Glw_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_CWLBc85Qgj22f--FEJ7Glw');
  var playerDetails = {"keywords":"","thumbnailUrl":"https://play.vidyard.com/CWLBc85Qgj22f--FEJ7Glw.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"CWLBc85Qgj22f--FEJ7Glw","description":"Learn more about Bulletin 140G molded case circuit breakers at http://ab.rockwellautomation.com/Circuit-and-Load-Protection/Circuit-Breakers/140G-Circuit-Breakers","name":"Installing a UV Release on a 140G Molded Case Circuit Breaker--Frames G, H, I, J","transcript":"","uploadDate":"2014-10-13T22:13:49.000Z","duration":"T3M11S","embedUrl":"https://play.vidyard.com/CWLBc85Qgj22f--FEJ7Glw","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_CWLBc85Qgj22f--FEJ7Glw") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_CWLBc85Qgj22f--FEJ7Glw();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/CWLBc85Qgj22f--FEJ7Glw.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_CWLBc85Qgj22f$$FEJ7Glw_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_CWLBc85Qgj22f$$FEJ7Glw_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_CWLBc85Qgj22f$$FEJ7Glw_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw = true;
          default:
            vidyard_CWLBc85Qgj22f$$FEJ7Glw_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type || vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type !== 'lightbox') {
    vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.hide_html5_playlist !== 'undefined' && vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw = query_player_width;
    vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw) / vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw;
    vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw = query_player_width;
    vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw) / vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw;
    vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw = query_player_width;
    vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_CWLBc85Qgj22f--FEJ7Glw");
  ...
  if (!iframe_container && vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_CWLBc85Qgj22f--FEJ7Glw';
  ...
  if (vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_CWLBc85Qgj22f$$FEJ7Glw = true;
    vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "CWLBc85Qgj22f--FEJ7Glw") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw === true && vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw');
        var message = {
          'event': 'parentReferer',
          'uuid': 'CWLBc85Qgj22f--FEJ7Glw',
          'data': {
            'value': vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.referring_url
          }
        }
      ...
      if (!vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.pardot_id = pardot_id;
      ...
      if (!vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.eloqua_id &&
            ((vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw === true && vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === 'lightbox') ||
             (vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === "inline" || vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'CWLBc85Qgj22f--FEJ7Glw';
          Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_CWLBc85Qgj22f$$FEJ7Glw = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_CWLBc85Qgj22f$$FEJ7Glw(false, vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw, vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_CWLBc85Qgj22f$$FEJ7Glw();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw')
      );

    } else if (vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['CWLBc85Qgj22f--FEJ7Glw'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_CWLBc85Qgj22f$$FEJ7Glw
  playerIframe = Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'CWLBc85Qgj22f--FEJ7Glw';
...
(function () {
  function async_load() {
    var contactId = vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/CWLBc85Qgj22f--FEJ7Glw/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_CWLBc85Qgj22f$$FEJ7Glw(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw');
  ...
  if (vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw === true) {
    query_params_string = vidyard_CWLBc85Qgj22f$$FEJ7Glw_raw_params;
  } else {
    for (var param in vidyard_CWLBc85Qgj22f$$FEJ7Glw_params) {
      var param_value = vidyard_CWLBc85Qgj22f$$FEJ7Glw_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_CWLBc85Qgj22f--FEJ7Glw" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_CWLBc85Qgj22f--FEJ7Glw" class="vidyard_iframe" src="//play.vidyard.com/CWLBc85Qgj22f--FEJ7Glw?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_CWLBc85Qgj22f$$FEJ7Glw() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw');
  if (_theframe) {
    ...
    if (vidyard_secure_CWLBc85Qgj22f$$FEJ7Glw === true && vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.type === 'lightbox') {
      vidyard_integration_check_CWLBc85Qgj22f$$FEJ7Glw();
    }
    ...
    if (vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_CWLBc85Qgj22f$$FEJ7Glw_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'CWLBc85Qgj22f--FEJ7Glw';
      Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw')
...
function fn_vidyard_CWLBc85Qgj22f$$FEJ7Glw() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_CWLBc85Qgj22f$$FEJ7Glw(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw,
            vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw,
            319 + (vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw');
        var vidyard_span = document.getElementById('vidyard_span_CWLBc85Qgj22f--FEJ7Glw');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('CWLBc85Qgj22f--FEJ7Glw').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_CWLBc85Qgj22f$$FEJ7Glw,
    height: vidyard_player_height_CWLBc85Qgj22f$$FEJ7Glw,
    animate: !vidyard_html5_CWLBc85Qgj22f$$FEJ7Glw,
    fixed: true
  });
}
