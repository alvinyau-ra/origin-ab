var vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n = 1278;
var vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n = 360;
var vidyard_html5_JyVUm2eVxKmCLGBg5t4P2n = false;
var vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n = false;
var vidyard_integration_check_JyVUm2eVxKmCLGBg5t4P2n = function() {};
var vidyard_JyVUm2eVxKmCLGBg5t4P2n_params = {};
var vidyard_JyVUm2eVxKmCLGBg5t4P2n_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_JyVUm2eVxKmCLGBg5t4P2n');
  var playerDetails = {"keywords":"HMI,pv800,PanelView 800,graphic terminals,micro control system,operator interface,smart micro automation,English,how to configure animation tag,how to create pv800 animation,panelview 800 animation,panelview800 animation,pv800 animation,2711R,how to add trend in panelview 800,panelview 800 graphic terminals,real-time trending,trend properties,panelview 800 trending,panelview800 trending,edit recipe on panelview 800,how to modify recipe on panelview 800,panelview 800 recipe management,panelview800 recipe,pv800 recipe,DesignStation,alarm history,connected components workbench software,connectivity,datalog,recipe,Micro Control,PVC,PanelView Component,graphic terminal,alarm,mixer,trend,CCW,Connected Components Workbench,VNC,remote,terminal,Human Machine Interface,remote access,communication,controller,switch,allen bradley,Allen-Bradley,Analog Gauge,automation,CompactLogix L1,Connected Components,HMI Objects,Industrial Automation,manufacturing,Multistate Indicator,Rockwell Automation,Rockwell Software,Trending,Micro800,PV 800,Latched Button,Rockwell Solution,Trend Object","thumbnailUrl":"https://play.vidyard.com/JyVUm2eVxKmCLGBg5t4P2n.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"JyVUm2eVxKmCLGBg5t4P2n","description":"This playlist showcases videos of the PanelView 800 Graphic Terminals from Rockwell Automation. \r\n\r\nTo learn more about PanelView 800 Graphic Terminals, visit: https://ab.rockwellautomation.com/Graphic-Terminals/2711R-PanelView-800-Graphic-Terminals","name":"PanelView™ 800 Graphic Terminals","transcript":"","uploadDate":"2017-06-05T08:03:09.000Z","duration":"T64M23S","embedUrl":"https://play.vidyard.com/JyVUm2eVxKmCLGBg5t4P2n","height":360,"width":1278};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_JyVUm2eVxKmCLGBg5t4P2n") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_JyVUm2eVxKmCLGBg5t4P2n();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/JyVUm2eVxKmCLGBg5t4P2n.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_JyVUm2eVxKmCLGBg5t4P2n_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_JyVUm2eVxKmCLGBg5t4P2n_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_JyVUm2eVxKmCLGBg5t4P2n_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n = true;
          default:
            vidyard_JyVUm2eVxKmCLGBg5t4P2n_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type || vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type !== 'lightbox') {
    vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = true && !(typeof vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.hide_html5_playlist !== 'undefined' && vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.hide_html5_playlist);
  var playlist_always_open = true;
  if (typeof vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n = query_player_width;
    vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n) / vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n;
    vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n = query_player_width;
    vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n) / vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n;
    vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n = query_player_width;
    vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_JyVUm2eVxKmCLGBg5t4P2n");
  ...
  if (!iframe_container && vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_JyVUm2eVxKmCLGBg5t4P2n';
  ...
  if (vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'JyVUm2eVxKmCLGBg5t4P2n') {
      vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_JyVUm2eVxKmCLGBg5t4P2n = true;
    vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "JyVUm2eVxKmCLGBg5t4P2n") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n === true && vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n');
        var message = {
          'event': 'parentReferer',
          'uuid': 'JyVUm2eVxKmCLGBg5t4P2n',
          'data': {
            'value': vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.referring_url
          }
        }
      ...
      if (!vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.pardot_id = pardot_id;
      ...
      if (!vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_id = marketo_id;
      ...
      if (vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type === "inline" || vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'JyVUm2eVxKmCLGBg5t4P2n';
          Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_JyVUm2eVxKmCLGBg5t4P2n = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_JyVUm2eVxKmCLGBg5t4P2n(false, vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n, vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_JyVUm2eVxKmCLGBg5t4P2n();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n')
      );

    } else if (vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['JyVUm2eVxKmCLGBg5t4P2n'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_JyVUm2eVxKmCLGBg5t4P2n
  playerIframe = Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'JyVUm2eVxKmCLGBg5t4P2n';
...
(function () {
  function async_load() {
    var contactId = vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/JyVUm2eVxKmCLGBg5t4P2n/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_JyVUm2eVxKmCLGBg5t4P2n(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n');
  ...
  if (vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n === true) {
    query_params_string = vidyard_JyVUm2eVxKmCLGBg5t4P2n_raw_params;
  } else {
    for (var param in vidyard_JyVUm2eVxKmCLGBg5t4P2n_params) {
      var param_value = vidyard_JyVUm2eVxKmCLGBg5t4P2n_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_JyVUm2eVxKmCLGBg5t4P2n" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_JyVUm2eVxKmCLGBg5t4P2n" class="vidyard_iframe" src="//play.vidyard.com/JyVUm2eVxKmCLGBg5t4P2n?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_JyVUm2eVxKmCLGBg5t4P2n() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n');
  if (_theframe) {
    ...
    if (vidyard_secure_JyVUm2eVxKmCLGBg5t4P2n === true && vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.type === 'lightbox') {
      vidyard_integration_check_JyVUm2eVxKmCLGBg5t4P2n();
    }
    ...
    if (vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_JyVUm2eVxKmCLGBg5t4P2n_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'JyVUm2eVxKmCLGBg5t4P2n';
      Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n')
...
function fn_vidyard_JyVUm2eVxKmCLGBg5t4P2n() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_JyVUm2eVxKmCLGBg5t4P2n(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n,
            vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n,
            319 + (vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n');
        var vidyard_span = document.getElementById('vidyard_span_JyVUm2eVxKmCLGBg5t4P2n');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('JyVUm2eVxKmCLGBg5t4P2n').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_JyVUm2eVxKmCLGBg5t4P2n,
    height: vidyard_player_height_JyVUm2eVxKmCLGBg5t4P2n,
    animate: !vidyard_html5_JyVUm2eVxKmCLGBg5t4P2n,
    fixed: true
  });
}
