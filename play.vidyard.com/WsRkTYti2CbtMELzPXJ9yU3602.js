var vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU = 640;
var vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU = 360;
var vidyard_html5_WsRkTYti2CbtMELzPXJ9yU = false;
var vidyard_secure_WsRkTYti2CbtMELzPXJ9yU = false;
var vidyard_integration_check_WsRkTYti2CbtMELzPXJ9yU = function() {};
var vidyard_WsRkTYti2CbtMELzPXJ9yU_params = {};
var vidyard_WsRkTYti2CbtMELzPXJ9yU_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_WsRkTYti2CbtMELzPXJ9yU');
  var playerDetails = {"keywords":"Basado en microprocesador,Clasificación más alta de seguridad,Estado sólido,Paro de emergencia","thumbnailUrl":"https://play.vidyard.com/WsRkTYti2CbtMELzPXJ9yU.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"WsRkTYti2CbtMELzPXJ9yU","description":"La capacidad de diagnóstico del interruptor accionado por cable Guardmaster Lifeline™ 5 le permite abordar posibles problemas antes de que ocasionen tiempo improductivo no programado. https://ab.rockwellautomation.com/es/push-buttons/emergency-stop/cable-pull/lifeline-5","name":"Video de interruptor accionado por cable Guardmaster® Lifeline 5","transcript":"","uploadDate":"2018-01-17T20:30:36.000Z","duration":"T2M25S","embedUrl":"https://play.vidyard.com/WsRkTYti2CbtMELzPXJ9yU","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_WsRkTYti2CbtMELzPXJ9yU") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_WsRkTYti2CbtMELzPXJ9yU();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/WsRkTYti2CbtMELzPXJ9yU.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_WsRkTYti2CbtMELzPXJ9yU_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_WsRkTYti2CbtMELzPXJ9yU_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_WsRkTYti2CbtMELzPXJ9yU_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_WsRkTYti2CbtMELzPXJ9yU = true;
          default:
            vidyard_WsRkTYti2CbtMELzPXJ9yU_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type || vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type !== 'lightbox') {
    vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_WsRkTYti2CbtMELzPXJ9yU_params.hide_html5_playlist !== 'undefined' && vidyard_WsRkTYti2CbtMELzPXJ9yU_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_WsRkTYti2CbtMELzPXJ9yU_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_WsRkTYti2CbtMELzPXJ9yU_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU = query_player_width;
    vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU) / vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU;
    vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU = query_player_width;
    vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU) / vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU;
    vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU = query_player_width;
    vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_WsRkTYti2CbtMELzPXJ9yU");
  ...
  if (!iframe_container && vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_WsRkTYti2CbtMELzPXJ9yU';
  ...
  if (vidyard_secure_WsRkTYti2CbtMELzPXJ9yU === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'WsRkTYti2CbtMELzPXJ9yU') {
      vidyard_WsRkTYti2CbtMELzPXJ9yU_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_WsRkTYti2CbtMELzPXJ9yU = true;
    vidyard_WsRkTYti2CbtMELzPXJ9yU_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "WsRkTYti2CbtMELzPXJ9yU") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_WsRkTYti2CbtMELzPXJ9yU === true && vidyard_WsRkTYti2CbtMELzPXJ9yU_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU');
        var message = {
          'event': 'parentReferer',
          'uuid': 'WsRkTYti2CbtMELzPXJ9yU',
          'data': {
            'value': vidyard_WsRkTYti2CbtMELzPXJ9yU_params.referring_url
          }
        }
      ...
      if (!vidyard_WsRkTYti2CbtMELzPXJ9yU_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_WsRkTYti2CbtMELzPXJ9yU_params.pardot_id = pardot_id;
      ...
      if (!vidyard_WsRkTYti2CbtMELzPXJ9yU_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_WsRkTYti2CbtMELzPXJ9yU_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_WsRkTYti2CbtMELzPXJ9yU_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_WsRkTYti2CbtMELzPXJ9yU_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_WsRkTYti2CbtMELzPXJ9yU_params.eloqua_id &&
            ((vidyard_secure_WsRkTYti2CbtMELzPXJ9yU === true && vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === 'lightbox') ||
             (vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_WsRkTYti2CbtMELzPXJ9yU_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === "inline" || vidyard_secure_WsRkTYti2CbtMELzPXJ9yU === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'WsRkTYti2CbtMELzPXJ9yU';
          Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_WsRkTYti2CbtMELzPXJ9yU = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_WsRkTYti2CbtMELzPXJ9yU(false, vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU, vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_WsRkTYti2CbtMELzPXJ9yU();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU')
      );

    } else if (vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_WsRkTYti2CbtMELzPXJ9yU) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_WsRkTYti2CbtMELzPXJ9yU_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['WsRkTYti2CbtMELzPXJ9yU'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_WsRkTYti2CbtMELzPXJ9yU
  playerIframe = Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'WsRkTYti2CbtMELzPXJ9yU';
...
(function () {
  function async_load() {
    var contactId = vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/WsRkTYti2CbtMELzPXJ9yU/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_WsRkTYti2CbtMELzPXJ9yU(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_WsRkTYti2CbtMELzPXJ9yU_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_WsRkTYti2CbtMELzPXJ9yU_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU');
  ...
  if (vidyard_secure_WsRkTYti2CbtMELzPXJ9yU === true) {
    query_params_string = vidyard_WsRkTYti2CbtMELzPXJ9yU_raw_params;
  } else {
    for (var param in vidyard_WsRkTYti2CbtMELzPXJ9yU_params) {
      var param_value = vidyard_WsRkTYti2CbtMELzPXJ9yU_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_WsRkTYti2CbtMELzPXJ9yU" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_WsRkTYti2CbtMELzPXJ9yU" class="vidyard_iframe" src="//play.vidyard.com/WsRkTYti2CbtMELzPXJ9yU?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_WsRkTYti2CbtMELzPXJ9yU() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU');
  if (_theframe) {
    ...
    if (vidyard_secure_WsRkTYti2CbtMELzPXJ9yU === true && vidyard_WsRkTYti2CbtMELzPXJ9yU_params.type === 'lightbox') {
      vidyard_integration_check_WsRkTYti2CbtMELzPXJ9yU();
    }
    ...
    if (vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_WsRkTYti2CbtMELzPXJ9yU_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'WsRkTYti2CbtMELzPXJ9yU';
      Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU')
...
function fn_vidyard_WsRkTYti2CbtMELzPXJ9yU() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_WsRkTYti2CbtMELzPXJ9yU(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU,
            vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU,
            319 + (vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU');
        var vidyard_span = document.getElementById('vidyard_span_WsRkTYti2CbtMELzPXJ9yU');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('WsRkTYti2CbtMELzPXJ9yU').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_WsRkTYti2CbtMELzPXJ9yU,
    height: vidyard_player_height_WsRkTYti2CbtMELzPXJ9yU,
    animate: !vidyard_html5_WsRkTYti2CbtMELzPXJ9yU,
    fixed: true
  });
}
