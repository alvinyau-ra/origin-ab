var vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy = 640;
var vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy = 360;
var vidyard_html5_GTN19zTe9ZY1RJV4Bgc8Jy = false;
var vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy = false;
var vidyard_integration_check_GTN19zTe9ZY1RJV4Bgc8Jy = function() {};
var vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params = {};
var vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_GTN19zTe9ZY1RJV4Bgc8Jy');
  var playerDetails = {"keywords":"artificial intelligence,ControlLogix,FactoryTalk Analytics,LogixAI,ControlLogix 5580,FactoryTalk,FactoryTalk Analytics LogixAI","thumbnailUrl":"https://play.vidyard.com/GTN19zTe9ZY1RJV4Bgc8Jy.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"GTN19zTe9ZY1RJV4Bgc8Jy","description":"What if you could predict anomalies like an overheating engine or a faulty drive? The FactoryTalk® Analytics™ LogixAI™ module provides embedded analytics that empower customers to apply machine learning concepts – no need to be a data scientist. Applying analytics within the controller application is a new fundamental approach to achieving process improvements.\r\n\r\nLearn more about the ControlLogix® 5580 controller and FactoryTalk® Analytics™ LogixAI™ module here: https://ab.rockwellautomation.com/Programmable-Controllers/ControlLogix/5580-Controllers#whatsnew. ","name":"FactoryTalk® Analytics™ LogixAI™: Coupling Artificial Intelligence with Logix","transcript":"","uploadDate":"2019-03-27T13:36:21.000Z","duration":"T2M48S","embedUrl":"https://play.vidyard.com/GTN19zTe9ZY1RJV4Bgc8Jy","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_GTN19zTe9ZY1RJV4Bgc8Jy") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_GTN19zTe9ZY1RJV4Bgc8Jy();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/GTN19zTe9ZY1RJV4Bgc8Jy.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy = true;
          default:
            vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type || vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type !== 'lightbox') {
    vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.hide_html5_playlist !== 'undefined' && vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy = query_player_width;
    vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy) / vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy;
    vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy = query_player_width;
    vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy) / vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy;
    vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy = query_player_width;
    vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_GTN19zTe9ZY1RJV4Bgc8Jy");
  ...
  if (!iframe_container && vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_GTN19zTe9ZY1RJV4Bgc8Jy';
  ...
  if (vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'GTN19zTe9ZY1RJV4Bgc8Jy') {
      vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_GTN19zTe9ZY1RJV4Bgc8Jy = true;
    vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "GTN19zTe9ZY1RJV4Bgc8Jy") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy === true && vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy');
        var message = {
          'event': 'parentReferer',
          'uuid': 'GTN19zTe9ZY1RJV4Bgc8Jy',
          'data': {
            'value': vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.referring_url
          }
        }
      ...
      if (!vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.pardot_id = pardot_id;
      ...
      if (!vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.eloqua_id &&
            ((vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy === true && vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === 'lightbox') ||
             (vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === "inline" || vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'GTN19zTe9ZY1RJV4Bgc8Jy';
          Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_GTN19zTe9ZY1RJV4Bgc8Jy = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_GTN19zTe9ZY1RJV4Bgc8Jy(false, vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy, vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_GTN19zTe9ZY1RJV4Bgc8Jy();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy')
      );

    } else if (vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['GTN19zTe9ZY1RJV4Bgc8Jy'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_GTN19zTe9ZY1RJV4Bgc8Jy
  playerIframe = Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'GTN19zTe9ZY1RJV4Bgc8Jy';
...
(function () {
  function async_load() {
    var contactId = vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/GTN19zTe9ZY1RJV4Bgc8Jy/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_GTN19zTe9ZY1RJV4Bgc8Jy(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy');
  ...
  if (vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy === true) {
    query_params_string = vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_raw_params;
  } else {
    for (var param in vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params) {
      var param_value = vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params[param];
      if (param_value === true) {
        param_value = '1';
      }
...
function fn_vidyard_iframe_after_load_GTN19zTe9ZY1RJV4Bgc8Jy() {
  ...
  if (_theframe) {
    ...
    if (vidyard_secure_GTN19zTe9ZY1RJV4Bgc8Jy === true && vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.type === 'lightbox') {
      vidyard_integration_check_GTN19zTe9ZY1RJV4Bgc8Jy();
    }
    ...
    if (vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_GTN19zTe9ZY1RJV4Bgc8Jy_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'GTN19zTe9ZY1RJV4Bgc8Jy';
      Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy')
...
function fn_vidyard_GTN19zTe9ZY1RJV4Bgc8Jy() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_GTN19zTe9ZY1RJV4Bgc8Jy(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy,
            vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy,
            319 + (vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy');
        var vidyard_span = document.getElementById('vidyard_span_GTN19zTe9ZY1RJV4Bgc8Jy');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('GTN19zTe9ZY1RJV4Bgc8Jy').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_GTN19zTe9ZY1RJV4Bgc8Jy,
    height: vidyard_player_height_GTN19zTe9ZY1RJV4Bgc8Jy,
    animate: !vidyard_html5_GTN19zTe9ZY1RJV4Bgc8Jy,
    fixed: true
  });
}
