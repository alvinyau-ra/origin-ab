var vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD = 640;
var vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD = 360;
var vidyard_html5_jxa16N6jFw6C3dmHUsJ9bD = false;
var vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD = false;
var vidyard_integration_check_jxa16N6jFw6C3dmHUsJ9bD = function() {};
var vidyard_jxa16N6jFw6C3dmHUsJ9bD_params = {};
var vidyard_jxa16N6jFw6C3dmHUsJ9bD_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_jxa16N6jFw6C3dmHUsJ9bD');
  var playerDetails = {"keywords":"HMI,PanelView 800,pv800,CompactLogix 连接,图形终端,微型控制系统,操作员界面","thumbnailUrl":"https://play.vidyard.com/jxa16N6jFw6C3dmHUsJ9bD.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"jxa16N6jFw6C3dmHUsJ9bD","description":"以下两分钟的短片向大家展示了罗克韦尔自动化新型 PanelView 800 图形终端的关键功能。 \r\n\r\n要了解有关 PanelView 800 图形终端的更多信息，请访问：https://ab.rockwellautomation.com/zh/Graphic-Terminals/2711R-PanelView-800-Graphic-Terminals","name":"PanelView™ 800 图形终端产品","transcript":"","uploadDate":"2018-08-07T04:32:32.000Z","duration":"T1M46S","embedUrl":"https://play.vidyard.com/jxa16N6jFw6C3dmHUsJ9bD","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_jxa16N6jFw6C3dmHUsJ9bD") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_jxa16N6jFw6C3dmHUsJ9bD();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/jxa16N6jFw6C3dmHUsJ9bD.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_jxa16N6jFw6C3dmHUsJ9bD_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_jxa16N6jFw6C3dmHUsJ9bD_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_jxa16N6jFw6C3dmHUsJ9bD_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD = true;
          default:
            vidyard_jxa16N6jFw6C3dmHUsJ9bD_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type || vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type !== 'lightbox') {
    vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.hide_html5_playlist !== 'undefined' && vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD = query_player_width;
    vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD) / vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD;
    vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD = query_player_width;
    vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD) / vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD;
    vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD = query_player_width;
    vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_jxa16N6jFw6C3dmHUsJ9bD");
  ...
  if (!iframe_container && vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_jxa16N6jFw6C3dmHUsJ9bD';
  ...
  if (vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'jxa16N6jFw6C3dmHUsJ9bD') {
      vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_jxa16N6jFw6C3dmHUsJ9bD = true;
    vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "jxa16N6jFw6C3dmHUsJ9bD") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD === true && vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD');
        var message = {
          'event': 'parentReferer',
          'uuid': 'jxa16N6jFw6C3dmHUsJ9bD',
          'data': {
            'value': vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.referring_url
          }
        }
      ...
      if (!vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.pardot_id = pardot_id;
      ...
      if (!vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_id = marketo_id;
      ...
      if (vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type === "inline" || vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'jxa16N6jFw6C3dmHUsJ9bD';
          Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_jxa16N6jFw6C3dmHUsJ9bD = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_jxa16N6jFw6C3dmHUsJ9bD(false, vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD, vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_jxa16N6jFw6C3dmHUsJ9bD();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD')
      );

    } else if (vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['jxa16N6jFw6C3dmHUsJ9bD'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_jxa16N6jFw6C3dmHUsJ9bD
  playerIframe = Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'jxa16N6jFw6C3dmHUsJ9bD';
...
(function () {
  function async_load() {
    var contactId = vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/jxa16N6jFw6C3dmHUsJ9bD/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_jxa16N6jFw6C3dmHUsJ9bD(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD');
  ...
  if (vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD === true) {
    query_params_string = vidyard_jxa16N6jFw6C3dmHUsJ9bD_raw_params;
  } else {
    for (var param in vidyard_jxa16N6jFw6C3dmHUsJ9bD_params) {
      var param_value = vidyard_jxa16N6jFw6C3dmHUsJ9bD_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_jxa16N6jFw6C3dmHUsJ9bD" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_jxa16N6jFw6C3dmHUsJ9bD" class="vidyard_iframe" src="//play.vidyard.com/jxa16N6jFw6C3dmHUsJ9bD?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_jxa16N6jFw6C3dmHUsJ9bD() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD');
  if (_theframe) {
    ...
    if (vidyard_secure_jxa16N6jFw6C3dmHUsJ9bD === true && vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.type === 'lightbox') {
      vidyard_integration_check_jxa16N6jFw6C3dmHUsJ9bD();
    }
    ...
    if (vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_jxa16N6jFw6C3dmHUsJ9bD_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'jxa16N6jFw6C3dmHUsJ9bD';
      Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD')
...
function fn_vidyard_jxa16N6jFw6C3dmHUsJ9bD() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_jxa16N6jFw6C3dmHUsJ9bD(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD,
            vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD,
            319 + (vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD');
        var vidyard_span = document.getElementById('vidyard_span_jxa16N6jFw6C3dmHUsJ9bD');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('jxa16N6jFw6C3dmHUsJ9bD').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_jxa16N6jFw6C3dmHUsJ9bD,
    height: vidyard_player_height_jxa16N6jFw6C3dmHUsJ9bD,
    animate: !vidyard_html5_jxa16N6jFw6C3dmHUsJ9bD,
    fixed: true
  });
}
