var vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP = 640;
var vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP = 360;
var vidyard_html5_q6ZM1Pzc2wer2tFJAozKGP = false;
var vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP = false;
var vidyard_integration_check_q6ZM1Pzc2wer2tFJAozKGP = function() {};
var vidyard_q6ZM1Pzc2wer2tFJAozKGP_params = {};
var vidyard_q6ZM1Pzc2wer2tFJAozKGP_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_q6ZM1Pzc2wer2tFJAozKGP');
  var playerDetails = {"keywords":"drive solutions,Korean,PowerFlex 755T,TotalFORCE Technology,AC Drives,Allen-Bradley,PowerFlex,Rockwell Automation","thumbnailUrl":"https://play.vidyard.com/q6ZM1Pzc2wer2tFJAozKGP.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"q6ZM1Pzc2wer2tFJAozKGP","description":"PowerFlex 755T 인버터는 다른 VFD에서 볼 수 없었던 혁신적인 기능도 제공합니다. 가장 중요한 점은 사용자의 애플리케이션이 향상된 처리 성능, 개선된 품질 및 감소된 가동 중단 시간을 달성할 수 있도록 특허 등록된 TotalFORCE 기술을 도입한 것입니다. 보다 자세한 내용은 영상이나 아래 링크를 통해 확인하십시오.    www.ab.com/drives\r\n","name":"PowerFlex 755T 인버터 솔루션 TotalFORCE 기술 2019 KO","transcript":"","uploadDate":"2017-04-11T14:29:34.000Z","duration":"T2M38S","embedUrl":"https://play.vidyard.com/q6ZM1Pzc2wer2tFJAozKGP","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_q6ZM1Pzc2wer2tFJAozKGP") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_q6ZM1Pzc2wer2tFJAozKGP();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/q6ZM1Pzc2wer2tFJAozKGP.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_q6ZM1Pzc2wer2tFJAozKGP_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_q6ZM1Pzc2wer2tFJAozKGP_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_q6ZM1Pzc2wer2tFJAozKGP_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP = true;
          default:
            vidyard_q6ZM1Pzc2wer2tFJAozKGP_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type || vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type !== 'lightbox') {
    vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.hide_html5_playlist !== 'undefined' && vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP = query_player_width;
    vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP) / vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP;
    vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP = query_player_width;
    vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP) / vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP;
    vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP = query_player_width;
    vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_q6ZM1Pzc2wer2tFJAozKGP");
  ...
  if (!iframe_container && vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_q6ZM1Pzc2wer2tFJAozKGP';
  ...
  if (vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'q6ZM1Pzc2wer2tFJAozKGP') {
      vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_q6ZM1Pzc2wer2tFJAozKGP = true;
    vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "q6ZM1Pzc2wer2tFJAozKGP") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP === true && vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP');
        var message = {
          'event': 'parentReferer',
          'uuid': 'q6ZM1Pzc2wer2tFJAozKGP',
          'data': {
            'value': vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.referring_url
          }
        }
      ...
      if (!vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.pardot_id = pardot_id;
      ...
      if (!vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.eloqua_id &&
            ((vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP === true && vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === 'lightbox') ||
             (vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === "inline" || vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'q6ZM1Pzc2wer2tFJAozKGP';
          Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_q6ZM1Pzc2wer2tFJAozKGP = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_q6ZM1Pzc2wer2tFJAozKGP(false, vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP, vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_q6ZM1Pzc2wer2tFJAozKGP();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP')
      );

    } else if (vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['q6ZM1Pzc2wer2tFJAozKGP'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_q6ZM1Pzc2wer2tFJAozKGP
  playerIframe = Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'q6ZM1Pzc2wer2tFJAozKGP';
...
(function () {
  function async_load() {
    var contactId = vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/q6ZM1Pzc2wer2tFJAozKGP/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_q6ZM1Pzc2wer2tFJAozKGP(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP');
  ...
  if (vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP === true) {
    query_params_string = vidyard_q6ZM1Pzc2wer2tFJAozKGP_raw_params;
  } else {
    for (var param in vidyard_q6ZM1Pzc2wer2tFJAozKGP_params) {
      var param_value = vidyard_q6ZM1Pzc2wer2tFJAozKGP_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_q6ZM1Pzc2wer2tFJAozKGP" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_q6ZM1Pzc2wer2tFJAozKGP" class="vidyard_iframe" src="//play.vidyard.com/q6ZM1Pzc2wer2tFJAozKGP?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_q6ZM1Pzc2wer2tFJAozKGP() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP');
  if (_theframe) {
    ...
    if (vidyard_secure_q6ZM1Pzc2wer2tFJAozKGP === true && vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.type === 'lightbox') {
      vidyard_integration_check_q6ZM1Pzc2wer2tFJAozKGP();
    }
    ...
    if (vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_q6ZM1Pzc2wer2tFJAozKGP_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'q6ZM1Pzc2wer2tFJAozKGP';
      Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP')
...
function fn_vidyard_q6ZM1Pzc2wer2tFJAozKGP() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_q6ZM1Pzc2wer2tFJAozKGP(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP,
            vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP,
            319 + (vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP');
        var vidyard_span = document.getElementById('vidyard_span_q6ZM1Pzc2wer2tFJAozKGP');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('q6ZM1Pzc2wer2tFJAozKGP').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_q6ZM1Pzc2wer2tFJAozKGP,
    height: vidyard_player_height_q6ZM1Pzc2wer2tFJAozKGP,
    animate: !vidyard_html5_q6ZM1Pzc2wer2tFJAozKGP,
    fixed: true
  });
}
