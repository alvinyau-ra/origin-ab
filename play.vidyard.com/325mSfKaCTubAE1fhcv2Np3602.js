var vidyard_player_width_325mSfKaCTubAE1fhcv2Np = 640;
var vidyard_player_height_325mSfKaCTubAE1fhcv2Np = 360;
var vidyard_html5_325mSfKaCTubAE1fhcv2Np = false;
var vidyard_secure_325mSfKaCTubAE1fhcv2Np = false;
var vidyard_integration_check_325mSfKaCTubAE1fhcv2Np = function() {};
var vidyard_325mSfKaCTubAE1fhcv2Np_params = {};
var vidyard_325mSfKaCTubAE1fhcv2Np_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_325mSfKaCTubAE1fhcv2Np');
  var playerDetails = {"keywords":"Micro800,micro870,Kompaktsteuerung,Micro-Anwendung,Micro-Steuerungssystem,Micro-Steuerungssystem für Maschinenbauer,Micro-Steuerungssystem für OEM,geeignete Anwendungen,speicherprogrammierbare Steuerung","thumbnailUrl":"https://play.vidyard.com/325mSfKaCTubAE1fhcv2Np.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"325mSfKaCTubAE1fhcv2Np","description":"Die neue Micro870®-Steuerung eignet sich für eine Vielzahl unterschiedlicher Anwendungen. In diesem Video erfahren Sie mehr! \r\n\r\nWeitere Informationen zu Micro870-Steuerungen finden Sie unter:\r\nhttp://ab.rockwellautomation.com/de/Programmable-Controllers/Micro870","name":"Anwendungsgebiete für Micro870®-Steuerungen","transcript":"","uploadDate":"2018-07-25T03:11:14.000Z","duration":"T2M47S","embedUrl":"https://play.vidyard.com/325mSfKaCTubAE1fhcv2Np","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_325mSfKaCTubAE1fhcv2Np") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_325mSfKaCTubAE1fhcv2Np();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/325mSfKaCTubAE1fhcv2Np.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_325mSfKaCTubAE1fhcv2Np_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_325mSfKaCTubAE1fhcv2Np_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_325mSfKaCTubAE1fhcv2Np_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_325mSfKaCTubAE1fhcv2Np = true;
          default:
            vidyard_325mSfKaCTubAE1fhcv2Np_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_325mSfKaCTubAE1fhcv2Np_params.type || vidyard_325mSfKaCTubAE1fhcv2Np_params.type !== 'lightbox') {
    vidyard_325mSfKaCTubAE1fhcv2Np_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_325mSfKaCTubAE1fhcv2Np_params.hide_html5_playlist !== 'undefined' && vidyard_325mSfKaCTubAE1fhcv2Np_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_325mSfKaCTubAE1fhcv2Np_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_325mSfKaCTubAE1fhcv2Np_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_325mSfKaCTubAE1fhcv2Np = query_player_width;
    vidyard_player_height_325mSfKaCTubAE1fhcv2Np = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_325mSfKaCTubAE1fhcv2Np) / vidyard_player_width_325mSfKaCTubAE1fhcv2Np;
    vidyard_player_width_325mSfKaCTubAE1fhcv2Np = query_player_width;
    vidyard_player_height_325mSfKaCTubAE1fhcv2Np = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_325mSfKaCTubAE1fhcv2Np) / vidyard_player_height_325mSfKaCTubAE1fhcv2Np;
    vidyard_player_width_325mSfKaCTubAE1fhcv2Np = query_player_width;
    vidyard_player_height_325mSfKaCTubAE1fhcv2Np = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_325mSfKaCTubAE1fhcv2Np");
  ...
  if (!iframe_container && vidyard_325mSfKaCTubAE1fhcv2Np_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_325mSfKaCTubAE1fhcv2Np';
  ...
  if (vidyard_secure_325mSfKaCTubAE1fhcv2Np === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === '325mSfKaCTubAE1fhcv2Np') {
      vidyard_325mSfKaCTubAE1fhcv2Np_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_325mSfKaCTubAE1fhcv2Np = true;
    vidyard_325mSfKaCTubAE1fhcv2Np_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "325mSfKaCTubAE1fhcv2Np") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_325mSfKaCTubAE1fhcv2Np === true && vidyard_325mSfKaCTubAE1fhcv2Np_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np');
        var message = {
          'event': 'parentReferer',
          'uuid': '325mSfKaCTubAE1fhcv2Np',
          'data': {
            'value': vidyard_325mSfKaCTubAE1fhcv2Np_params.referring_url
          }
        }
      ...
      if (!vidyard_325mSfKaCTubAE1fhcv2Np_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_325mSfKaCTubAE1fhcv2Np_params.pardot_id = pardot_id;
      ...
      if (!vidyard_325mSfKaCTubAE1fhcv2Np_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_325mSfKaCTubAE1fhcv2Np_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_325mSfKaCTubAE1fhcv2Np_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_325mSfKaCTubAE1fhcv2Np_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_id = marketo_id;
      ...
      if (vidyard_325mSfKaCTubAE1fhcv2Np_params.type === "inline" || vidyard_secure_325mSfKaCTubAE1fhcv2Np === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = '325mSfKaCTubAE1fhcv2Np';
          Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_325mSfKaCTubAE1fhcv2Np = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_325mSfKaCTubAE1fhcv2Np_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_325mSfKaCTubAE1fhcv2Np(false, vidyard_player_width_325mSfKaCTubAE1fhcv2Np, vidyard_player_height_325mSfKaCTubAE1fhcv2Np);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_325mSfKaCTubAE1fhcv2Np();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np')
      );

    } else if (vidyard_325mSfKaCTubAE1fhcv2Np_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_325mSfKaCTubAE1fhcv2Np) {
          integration_tracking_check();
        }
  ...
  Vidyard._players['325mSfKaCTubAE1fhcv2Np'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_325mSfKaCTubAE1fhcv2Np
  playerIframe = Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = '325mSfKaCTubAE1fhcv2Np';
...
(function () {
  function async_load() {
    var contactId = vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/325mSfKaCTubAE1fhcv2Np/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_325mSfKaCTubAE1fhcv2Np(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_325mSfKaCTubAE1fhcv2Np_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_325mSfKaCTubAE1fhcv2Np_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np');
  ...
  if (vidyard_secure_325mSfKaCTubAE1fhcv2Np === true) {
    query_params_string = vidyard_325mSfKaCTubAE1fhcv2Np_raw_params;
  } else {
    for (var param in vidyard_325mSfKaCTubAE1fhcv2Np_params) {
      var param_value = vidyard_325mSfKaCTubAE1fhcv2Np_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_325mSfKaCTubAE1fhcv2Np" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_325mSfKaCTubAE1fhcv2Np" class="vidyard_iframe" src="//play.vidyard.com/325mSfKaCTubAE1fhcv2Np?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_325mSfKaCTubAE1fhcv2Np() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np');
  if (_theframe) {
    ...
    if (vidyard_secure_325mSfKaCTubAE1fhcv2Np === true && vidyard_325mSfKaCTubAE1fhcv2Np_params.type === 'lightbox') {
      vidyard_integration_check_325mSfKaCTubAE1fhcv2Np();
    }
    ...
    if (vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_325mSfKaCTubAE1fhcv2Np_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = '325mSfKaCTubAE1fhcv2Np';
      Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np')
...
function fn_vidyard_325mSfKaCTubAE1fhcv2Np() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_325mSfKaCTubAE1fhcv2Np / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_325mSfKaCTubAE1fhcv2Np(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_325mSfKaCTubAE1fhcv2Np,
            vidyard_player_height_325mSfKaCTubAE1fhcv2Np,
            319 + (vidyard_player_width_325mSfKaCTubAE1fhcv2Np / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np');
        var vidyard_span = document.getElementById('vidyard_span_325mSfKaCTubAE1fhcv2Np');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('325mSfKaCTubAE1fhcv2Np').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_325mSfKaCTubAE1fhcv2Np,
    height: vidyard_player_height_325mSfKaCTubAE1fhcv2Np,
    animate: !vidyard_html5_325mSfKaCTubAE1fhcv2Np,
    fixed: true
  });
}
