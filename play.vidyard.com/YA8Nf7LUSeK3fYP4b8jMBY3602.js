var vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY = 640;
var vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY = 360;
var vidyard_html5_YA8Nf7LUSeK3fYP4b8jMBY = false;
var vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY = false;
var vidyard_integration_check_YA8Nf7LUSeK3fYP4b8jMBY = function() {};
var vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params = {};
var vidyard_YA8Nf7LUSeK3fYP4b8jMBY_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_YA8Nf7LUSeK3fYP4b8jMBY');
  var playerDetails = {"keywords":"HMI,Logix 통합,PanelView 5000,그래픽 터미널,비디오","thumbnailUrl":"https://play.vidyard.com/YA8Nf7LUSeK3fYP4b8jMBY.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"YA8Nf7LUSeK3fYP4b8jMBY","description":"직관적이고 현대적인 디자인의 PanelView™ 5000 그래픽 터미널은 Studio 5000 View Designer™ 소프트웨어를 사용해서 향상된 Logix 통합을 제공합니다. http://ab.rockwellautomation.com/Graphic-Terminals/2715-PanelView-5500-Graphic-Terminals 에서 자세한 내용을 알아보십시오.","name":"PanelView 5000 그래픽 터미널 제품군 소개 비디오","transcript":"","uploadDate":"2018-09-04T18:24:43.000Z","duration":"T2M45S","embedUrl":"https://play.vidyard.com/YA8Nf7LUSeK3fYP4b8jMBY","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_YA8Nf7LUSeK3fYP4b8jMBY") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_YA8Nf7LUSeK3fYP4b8jMBY();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/YA8Nf7LUSeK3fYP4b8jMBY.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_YA8Nf7LUSeK3fYP4b8jMBY_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY = true;
          default:
            vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type || vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type !== 'lightbox') {
    vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.hide_html5_playlist !== 'undefined' && vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY = query_player_width;
    vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY) / vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY;
    vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY = query_player_width;
    vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY) / vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY;
    vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY = query_player_width;
    vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_YA8Nf7LUSeK3fYP4b8jMBY");
  ...
  if (!iframe_container && vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_YA8Nf7LUSeK3fYP4b8jMBY';
  ...
  if (vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'YA8Nf7LUSeK3fYP4b8jMBY') {
      vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_YA8Nf7LUSeK3fYP4b8jMBY = true;
    vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "YA8Nf7LUSeK3fYP4b8jMBY") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY === true && vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY');
        var message = {
          'event': 'parentReferer',
          'uuid': 'YA8Nf7LUSeK3fYP4b8jMBY',
          'data': {
            'value': vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.referring_url
          }
        }
      ...
      if (!vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.pardot_id = pardot_id;
      ...
      if (!vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.eloqua_id &&
            ((vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY === true && vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === 'lightbox') ||
             (vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === "inline" || vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'YA8Nf7LUSeK3fYP4b8jMBY';
          Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_YA8Nf7LUSeK3fYP4b8jMBY = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_YA8Nf7LUSeK3fYP4b8jMBY(false, vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY, vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_YA8Nf7LUSeK3fYP4b8jMBY();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY')
      );

    } else if (vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['YA8Nf7LUSeK3fYP4b8jMBY'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_YA8Nf7LUSeK3fYP4b8jMBY
  playerIframe = Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'YA8Nf7LUSeK3fYP4b8jMBY';
...
(function () {
  function async_load() {
    var contactId = vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/YA8Nf7LUSeK3fYP4b8jMBY/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_YA8Nf7LUSeK3fYP4b8jMBY(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY');
  ...
  if (vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY === true) {
    query_params_string = vidyard_YA8Nf7LUSeK3fYP4b8jMBY_raw_params;
  } else {
    for (var param in vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params) {
      var param_value = vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_YA8Nf7LUSeK3fYP4b8jMBY" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_YA8Nf7LUSeK3fYP4b8jMBY" class="vidyard_iframe" src="//play.vidyard.com/YA8Nf7LUSeK3fYP4b8jMBY?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_YA8Nf7LUSeK3fYP4b8jMBY() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY');
  if (_theframe) {
    ...
    if (vidyard_secure_YA8Nf7LUSeK3fYP4b8jMBY === true && vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.type === 'lightbox') {
      vidyard_integration_check_YA8Nf7LUSeK3fYP4b8jMBY();
    }
    ...
    if (vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_YA8Nf7LUSeK3fYP4b8jMBY_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'YA8Nf7LUSeK3fYP4b8jMBY';
      Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY')
...
function fn_vidyard_YA8Nf7LUSeK3fYP4b8jMBY() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_YA8Nf7LUSeK3fYP4b8jMBY(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY,
            vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY,
            319 + (vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY');
        var vidyard_span = document.getElementById('vidyard_span_YA8Nf7LUSeK3fYP4b8jMBY');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('YA8Nf7LUSeK3fYP4b8jMBY').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_YA8Nf7LUSeK3fYP4b8jMBY,
    height: vidyard_player_height_YA8Nf7LUSeK3fYP4b8jMBY,
    animate: !vidyard_html5_YA8Nf7LUSeK3fYP4b8jMBY,
    fixed: true
  });
}
