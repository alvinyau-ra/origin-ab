var vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE = 640;
var vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE = 360;
var vidyard_html5_AkQtrHE8nExJJ5K8LaRPXE = false;
var vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE = false;
var vidyard_integration_check_AkQtrHE8nExJJ5K8LaRPXE = function() {};
var vidyard_AkQtrHE8nExJJ5K8LaRPXE_params = {};
var vidyard_AkQtrHE8nExJJ5K8LaRPXE_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_AkQtrHE8nExJJ5K8LaRPXE');
  var playerDetails = {"keywords":"Allen-Bradley,Rockwell Automation,VFD,medium voltage ac drives,6000,MCC,Medium Voltage,Motor Control,PowerFlex","thumbnailUrl":"https://play.vidyard.com/AkQtrHE8nExJJ5K8LaRPXE.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"AkQtrHE8nExJJ5K8LaRPXE","description":"Our PowerFlex® 6000 Medium Voltage AC Drives allow for flexibility in a variety of applications. Learn more at https://ab.rockwellautomation.com/Drives/Medium-Voltage/PowerFlex-6000","name":"PowerFlex 6000 Medium Voltage AC Drive with Reduced Footprint","transcript":"PowerFlex 6000 medium voltage variable frequency drives\nhave been your go-to drives for general purpose applications\nsince their launch in 2013.\nPowerFlex 6000 drives are designed\nfor applications ranging from 2.3kV to 11kV and have an overall current rating of 680 A.\nAnd now, they're available in a smaller footprint.\nPowerFlex 6000 compact drives work well in most retrofit projects\nwhere the drive needs to fit into an existing space.\nThey're available in three different frame sizes: 70 A, 140 A and 215 A\nand each has a voltage rating of up to 4.16 kV.\nEach frame is available as one enclosure with all the internal as one enclosure with all the internal cables already connected.\nPowerFlex 6000 compact drives are still available with synchronous transfer\ncapability, enabling energy savings\nand reducing capital costs.\nTheir reliable design and proven technology\nmake these drives the ideal choice for\nvariable and constant torque applications.\nThe enhanced compact enclosure houses\nsize optimized internal components\nthat gives the drives a minimum meantime between failure\nrate of 100,000 hours.\ndue to the placement of the top and bottom line load cables.\nthere's no need for rear access.\nThis makes it easier for installation,\nmaintenance and troubleshooting.\nInternally powered Eco designed cooling fans\nprovide optimum energy efficiency.\nWashable air filters help reduce inventory costs.\nPowerFlex 6000 compact drives\nAlso include the safety features you've come\nto rely on from Allen-Bradley medium voltage drives\nand the reduced footprint drives offer the same\nproven technology as all PowerFlex 6000 medium voltage drives.\nThe high-efficiency phase shifting transformer\nprovides an overall drive efficiency of up to 96.5%,\nwhich helps reduce your operating costs.\nPowerFlex 6000 compact drives are\navailable with solid-state automatic cell bypass for increased uptime\nwithout increasing its footprint.\nThey feature an intuitive, easy to use 10 inch color\ntouch screen as well as faceplates at\nadd-on instructions and add-on profiles\nthat integrate into our Studio 5000 software suite.\nLike all PowerFlex 6000 drives,\nthe compact models are available with\nVolts per Hertz for sensorless vector control.\nThis and other flexible control features\nhelp make them suitable for general purpose\napplications like fans, pumps and compressors.\nOur new PowerFlex 6000 compact medium voltage\nvariable frequency drives offer the\nsame excellent reliability you've always\ncounted on, but in a smaller footprint.\nThey can help you meet or exceed your technical expectations,\nreduce commissioning time and enhance safety.\nVisit our website to learn more\nor contact your local Rockwell Automation\nsales rep or distributor.\n","uploadDate":"2019-11-08T19:20:47.000Z","duration":"T3M6S","embedUrl":"https://play.vidyard.com/AkQtrHE8nExJJ5K8LaRPXE","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_AkQtrHE8nExJJ5K8LaRPXE") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_AkQtrHE8nExJJ5K8LaRPXE();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/AkQtrHE8nExJJ5K8LaRPXE.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_AkQtrHE8nExJJ5K8LaRPXE_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_AkQtrHE8nExJJ5K8LaRPXE_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_AkQtrHE8nExJJ5K8LaRPXE_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE = true;
          default:
            vidyard_AkQtrHE8nExJJ5K8LaRPXE_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type || vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type !== 'lightbox') {
    vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.hide_html5_playlist !== 'undefined' && vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE = query_player_width;
    vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE) / vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE;
    vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE = query_player_width;
    vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE) / vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE;
    vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE = query_player_width;
    vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_AkQtrHE8nExJJ5K8LaRPXE");
  ...
  if (!iframe_container && vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_AkQtrHE8nExJJ5K8LaRPXE';
  ...
  if (vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'AkQtrHE8nExJJ5K8LaRPXE') {
      vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_AkQtrHE8nExJJ5K8LaRPXE = true;
    vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "AkQtrHE8nExJJ5K8LaRPXE") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE === true && vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE');
        var message = {
          'event': 'parentReferer',
          'uuid': 'AkQtrHE8nExJJ5K8LaRPXE',
          'data': {
            'value': vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.referring_url
          }
        }
      ...
      if (!vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.pardot_id = pardot_id;
      ...
      if (!vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.eloqua_id &&
            ((vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE === true && vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === 'lightbox') ||
             (vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === "inline" || vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'AkQtrHE8nExJJ5K8LaRPXE';
          Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_AkQtrHE8nExJJ5K8LaRPXE = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_AkQtrHE8nExJJ5K8LaRPXE(false, vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE, vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_AkQtrHE8nExJJ5K8LaRPXE();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE')
      );

    } else if (vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['AkQtrHE8nExJJ5K8LaRPXE'] = '';
}());
...
var vyContactCallback = function(data) {
  ...
  vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_AkQtrHE8nExJJ5K8LaRPXE
  playerIframe = Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'AkQtrHE8nExJJ5K8LaRPXE';
...
(function () {
  function async_load() {
    var contactId = vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/AkQtrHE8nExJJ5K8LaRPXE/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_AkQtrHE8nExJJ5K8LaRPXE(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE');
  ...
  if (vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE === true) {
    query_params_string = vidyard_AkQtrHE8nExJJ5K8LaRPXE_raw_params;
  } else {
    for (var param in vidyard_AkQtrHE8nExJJ5K8LaRPXE_params) {
      var param_value = vidyard_AkQtrHE8nExJJ5K8LaRPXE_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_AkQtrHE8nExJJ5K8LaRPXE" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_AkQtrHE8nExJJ5K8LaRPXE" class="vidyard_iframe" src="//play.vidyard.com/AkQtrHE8nExJJ5K8LaRPXE?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_AkQtrHE8nExJJ5K8LaRPXE() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE');
  if (_theframe) {
    ...
    if (vidyard_secure_AkQtrHE8nExJJ5K8LaRPXE === true && vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.type === 'lightbox') {
      vidyard_integration_check_AkQtrHE8nExJJ5K8LaRPXE();
    }
    ...
    if (vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_AkQtrHE8nExJJ5K8LaRPXE_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'AkQtrHE8nExJJ5K8LaRPXE';
      Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE')
...
function fn_vidyard_AkQtrHE8nExJJ5K8LaRPXE() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_AkQtrHE8nExJJ5K8LaRPXE(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE,
            vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE,
            319 + (vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE');
        var vidyard_span = document.getElementById('vidyard_span_AkQtrHE8nExJJ5K8LaRPXE');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('AkQtrHE8nExJJ5K8LaRPXE').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_AkQtrHE8nExJJ5K8LaRPXE,
    height: vidyard_player_height_AkQtrHE8nExJJ5K8LaRPXE,
    animate: !vidyard_html5_AkQtrHE8nExJJ5K8LaRPXE,
    fixed: true
  });
}
